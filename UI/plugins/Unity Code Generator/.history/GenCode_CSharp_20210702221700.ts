...
function genCode(handler: FairyEditor.PublishHandler) {
    let globalsettings = <FairyEditor.GlobalPublishSettings>handler.project.GetSettings("Publish");
    ...
    for (let i: number = 0; i < classCnt; i++) {
        ...
        for (let j: number = 0; j < memberCnt; j++) {
            ...
            console.log(memberInfo.group + "   " + memberInfo.index + "   " + memberInfo.name + "   " + memberInfo.res + "   " + memberInfo.type + "   " + memberInfo.varName)
