...
public struct EventKey
{
    ...
    public static readonly EventKey FriendApplicationChanged = new EventKey(35);
    public static readonly EventKey FriendListChanged = new EventKey(36);
    public static readonly EventKey FriendRequestEnergyListChanged = new EventKey(37);
    public static readonly EventKey FriendSendEnergyListChanged = new EventKey(38);
    public static readonly EventKey BankOpen = new EventKey(39);
    public static readonly EventKey BankClose = new EventKey(40);
    public static readonly EventKey GainFashionTicket = new EventKey(41);
    public static readonly EventKey SpentFashionTicket = new EventKey(42);
    public static readonly EventKey GuildMessageUpdated = new EventKey(43);
    public static readonly EventKey AnalyticsUpdated = new EventKey(44);
    public static readonly EventKey AchievementUpdated = new EventKey(45);
    public static readonly EventKey StartGuide = new EventKey(46);
