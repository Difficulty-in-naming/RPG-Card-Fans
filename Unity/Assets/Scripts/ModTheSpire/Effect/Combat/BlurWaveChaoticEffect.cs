...
{
    public class BlurWaveChaoticEffect :AbstractEffect
    {
        ...
        public BlurWaveChaoticEffect(float x, float y, Color color, float speed)
        {
        ...
        public override void Update()
        {
            ...
            if(this.mStallTimer < 0) {
                ...
                mLoader.SetScale(this.mScale + Random.Range(-0.1f, 0.1f), this.mScale + Random.Range(-0.1f, 0.1f));
                mLoader.rotation = this.mRotation + this.mFlipper + Random.Range(-30, 31);
