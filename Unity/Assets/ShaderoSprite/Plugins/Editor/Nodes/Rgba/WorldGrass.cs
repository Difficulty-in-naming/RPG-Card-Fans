...
{
[Node(false, "World Grass/World Grass FX")]
public class WorldGrass : Node
{ 
        [HideInInspector]
        public const string ID = "WorldGrass";
        [HideInInspector]
    ...
    {
            code = "";
            code += "float4 WorldGrassDistortion(float3 worldpos, float2 uv, sampler2D t, sampler2D o, float zoom, float worldsize, float shadowintensity, float windspeed, float winddirection, float grassdirection)\n";
            code += "{\n";
            code += "float2 u = uv;\n";
            code += "float2 u2 = uv;\n";
        ...
        public override Node Create(Vector2 pos)
    {
        Function();
            ...
            WorldGrass node = ScriptableObject.CreateInstance<WorldGrass>();
             
        node.name = "Word Grass FX";
    ...
    {
        Texture2D preview = ResourceManager.LoadTexture("Textures/previews/nid_grass.jpg");
