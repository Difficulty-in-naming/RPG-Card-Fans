...
public class MaskAlpha : Node
{
    ...
    public override bool Calculate()
    {
        ...
        if (parametersOK)
        {
            if (Include_RGBA_Alpha) s_out.ValueLine = "float4 " + DefaultName + "=" + PreviewVariable + ";\n" + DefaultName + ".a = lerp(" + PreviewVariable2 + ".a * " + PreviewVariable + ".a, (1 - " + PreviewVariable2 + ".a) * " + PreviewVariable + ".a," + DefaultNameVariable1 + ");\n";
            else s_out.ValueLine = "float4 " + DefaultName + "=" + PreviewVariable + ";\n" + DefaultName + ".a = lerp(" + PreviewVariable2 + ".a, 1 - " + PreviewVariable2 + ".a," + DefaultNameVariable1 + ");\n";
        }
        else
        {
             if (Include_RGBA_Alpha) s_out.ValueLine = "float4 " + DefaultName + "=" + PreviewVariable + ";\n" + DefaultName + ".a = lerp(" + PreviewVariable2 + ".a * " + PreviewVariable + ".a, (1 - " + PreviewVariable2 + ".a) * " + PreviewVariable + ".a," + Variable.ToString() + ");\n";
             else s_out.ValueLine = "float4 " + DefaultName + "=" + PreviewVariable + ";\n" + DefaultName + ".a = lerp(" + PreviewVariable2 + ".a, 1 - " + PreviewVariable2 + ".a ," + Variable.ToString() + ");\n";
