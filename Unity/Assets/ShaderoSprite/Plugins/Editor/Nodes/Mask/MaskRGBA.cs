...
public class MaskRGBA : Node
{
    ...
    public override bool Calculate()
    {
        ...
        if (parametersOK)
        {
            if (Include_RGBA_Alpha) s_out.ValueLine = "float4 "+ DefaultName +"="+ PreviewVariable + ";\n"+ DefaultName + ".a = lerp(" + PreviewVariable2 + ".r * " + PreviewVariable + ".a, (1 - " + PreviewVariable2 + ".r) * " + PreviewVariable + ".a," + DefaultNameVariable1 + ");\n";
            else s_out.ValueLine = "float4 " + DefaultName + "=" + PreviewVariable + ";\n" + DefaultName + ".a = lerp(" + PreviewVariable2 + ".r, 1 - " + PreviewVariable2 + ".r ," + DefaultNameVariable1 + ");\n";
        }
        else
        {
             if (Include_RGBA_Alpha) s_out.ValueLine = "float4 " + DefaultName + "=" + PreviewVariable + ";\n" + DefaultName + ".a = lerp(" + PreviewVariable2 + ".r * " + PreviewVariable + ".a, (1 - " + PreviewVariable2 + ".r) * " + PreviewVariable + ".a," + Variable.ToString() + ");\n";
             else s_out.ValueLine = "float4 " + DefaultName + "=" + PreviewVariable + ";\n" + DefaultName + ".a = lerp(" + PreviewVariable2 + ".r, 1 - " + PreviewVariable2 + ".r ," + Variable.ToString() + ");\n";
