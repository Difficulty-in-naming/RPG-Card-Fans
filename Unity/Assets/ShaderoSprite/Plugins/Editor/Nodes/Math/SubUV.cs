...
{
[Node(false, "UV/Math (UV)/Sub UV")]
public class SubUV : Node
{
    [HideInInspector]
    public const string ID = "SubUV";
    [HideInInspector]
    ...
    {
            SubUV node = ScriptableObject.CreateInstance<SubUV>();
    ...
    {
        Texture2D preview = ResourceManager.LoadTexture("Textures/previews/nid_uvsub.jpg");
    ...
    public override bool Calculate()
    {
        ...
        string DefaultName = "SubUV_" + NodeCount;
        string DefaultNameVariable1 = "_SubUV_Fade_" + NodeCount;
