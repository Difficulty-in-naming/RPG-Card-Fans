...
{
[Node(false, "UV/Math (UV)/Div UV")]
public class DivUV : Node
{
    [HideInInspector]
    public const string ID = "DivUV";
    [HideInInspector]
    ...
    {
            DivUV node = ScriptableObject.CreateInstance<DivUV>();
    ...
    {
        Texture2D preview = ResourceManager.LoadTexture("Textures/previews/nid_uvdiv.jpg");
    ...
    public override bool Calculate()
    {
        ...
        string DefaultName = "DivUV_" + NodeCount;
        string DefaultNameVariable1 = "_DivUV_Fade_" + NodeCount;
