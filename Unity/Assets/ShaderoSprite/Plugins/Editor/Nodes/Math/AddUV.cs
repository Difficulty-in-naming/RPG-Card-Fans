...
{
[Node(false, "UV/Math (UV)/Add UV")]
public class AddUV : Node
{
    [HideInInspector]
    public const string ID = "AddUV";
    [HideInInspector]
    ...
    {
        AddUV node = ScriptableObject.CreateInstance<AddUV>();
    ...
    {
        Texture2D preview = ResourceManager.LoadTexture("Textures/previews/nid_uvadd.jpg");
    ...
    public override bool Calculate()
    {
        ...
        string DefaultName = "AddUV_" + NodeCount;
        string DefaultNameVariable1 = "_addUV_Fade_" + NodeCount;
        ...
        s_out.StringPreviewLines = s_in.StringPreviewNew+ s_in2.StringPreviewNew;
            ...
            if (parametersOK)
            {
                s_out.ValueLine = "float2 " + DefaultName + "=" + PreviewVariable + ";\n" + DefaultName + " = lerp(" + PreviewVariable + "," + PreviewVariable + " + " + PreviewVariable2 + "," + DefaultNameVariable1 + ");\n";
            }
            else
            {
                s_out.ValueLine = "float2 " + DefaultName + "=" + PreviewVariable + ";\n" + DefaultName + " = lerp(" + PreviewVariable + "," + PreviewVariable + " + " + PreviewVariable2 + "," + Value1 + ");\n";
            }
