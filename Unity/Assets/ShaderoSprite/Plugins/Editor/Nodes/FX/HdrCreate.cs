...
{
[Node(false, "RGBA/Color/Hdr Create")]
public class HdrCreate : Node
{
    [HideInInspector]
    public const string ID = "HdrCreate";
    [HideInInspector]
    ...
    {
        code = "";
        code += "float4 HdrCreate(float4 txt,float value)\n";
        code += "{\n";
        code += "if (txt.r>0.98) txt.r=2;\n";
        code += "if (txt.g>0.98) txt.g=2;\n";
        code += "if (txt.b>0.98) txt.b=2;\n";
    ...
    public override Node Create(Vector2 pos)
    {
        ...
        HdrCreate node = ScriptableObject.CreateInstance<HdrCreate>();
        node.name = "Hdr Create";
    ...
    {
        Texture2D preview = ResourceManager.LoadTexture("Textures/previews/nid_hdrcreate.jpg");
    ...
    public override bool Calculate()
    {
        ...
        string DefaultName = "HdrCreate_" + NodeCount;
        string DefaultNameVariable1 = "_HdrCreate_Value_" + NodeCount;
        string DefaultParameters1 = ", Range(0, 4)) = " + Variable.ToString();
        string VoidName = "HdrCreate";
