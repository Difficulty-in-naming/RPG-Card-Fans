...
namespace _ShaderoShaderEditorFramework
{
    public abstract class Node : ScriptableObject
    {
        ...
        public static void InitValueCount()
        {
            ...
            NormalMapTag = false;
            LerpUV.Init();
            PaletteSwapping2Texture.Init();
            Generate_3DSphere.Init();
            Palette4Swapping.Init();
            AutomaticLerp.Init();
            ...
            Generate_Simple3DSphere.Init();
            Generate_3DPlanet.Init();
            ColorGradients2.Init();
            FlipUV_V.Init();
            RotationUV.Init();
            PageCurl.Init();
            GrayScale.Init();
            ...
            RGBA_Div.Init();
            DamageIncrustation.Init();
            DamageIncrustationTint.Init();
            SlicedVerticalBarUV.Init();
            GenerateAtlasTextureUV.Init();
            RGBA_Add.Init();
            RGBA_Mul.Init();
            RGBA_Sub.Init();
            Generate_LightningFX.Init();
            MainTexture.Init();
            PolarCoordinatesUV.Init();
            SlicedHorizontalBarUV.Init();
            NewTexture.Init();
            SourceNewTexture.Init();
            OperationBlend.Init();
            Generate_Voronoi.Init();
            SimpleDisplacementRotativeUV.Init();
            OperationAdd.Init();
            OperationDiv.Init();
            OperationLerp.Init();
            OperationMul.Init();
            ...
            OffsetUV.Init();
            GrabPass.Init();
            AuraDisplacementPack.Init();
            AnimatedShakeUV.Init();
            RGBA2Split.Init();
            Split2RGBA.Init();
            Desintegration.Init();
            Destroyer.Init();
