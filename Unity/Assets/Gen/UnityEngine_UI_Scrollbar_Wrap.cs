...
{
    public static class UnityEngine_UI_Scrollbar_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.UI.Scrollbar constructor");
        ...
        private static void M_SetValueWithoutNotify(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Scrollbar;
            ...
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var Arg0 = (UnityEngine.UI.Scrollbar.Direction)argHelper0.GetInt32(false);
        ...
        private static void S_direction(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Scrollbar;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.direction = (UnityEngine.UI.Scrollbar.Direction)argHelper.GetInt32(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_numberOfSteps(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Scrollbar;
                var result = obj.numberOfSteps;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_numberOfSteps(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Scrollbar;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.numberOfSteps = argHelper.GetInt32(false);
        ...
        private static void S_onValueChanged(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Scrollbar;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.onValueChanged = argHelper.Get<UnityEngine.UI.Scrollbar.ScrollEvent>(false);
...
{"numberOfSteps", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_numberOfSteps, Setter = S_numberOfSteps} },
