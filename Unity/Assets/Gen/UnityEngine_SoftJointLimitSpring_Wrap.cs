...
{
    public static class UnityEngine_SoftJointLimitSpring_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.SoftJointLimitSpring();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.SoftJointLimitSpring), result);
        ...
        private static void G_spring(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.SoftJointLimitSpring)Puerts.Utils.GetSelf((int)data, self);
