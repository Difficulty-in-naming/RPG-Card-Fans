...
namespace PuertsStaticWrap
{
    public static class UnityEngine_ImageConversion_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.ImageConversion constructor");
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_EncodeArrayToTGA(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                if (paramLen == 5)
                ...
                if (paramLen == 4)
                {
                        ...
                        && argHelper3.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var Arg2 = argHelper2.GetUInt32(false);
                        var Arg3 = argHelper3.GetUInt32(false);
                        var result = UnityEngine.ImageConversion.EncodeArrayToTGA(Arg0,Arg1,Arg2,Arg3);
                        Puerts.ResultHelper.Set((int)data, isolate, info, result);
                        return;
                    }
                }
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_EncodeArrayToPNG(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                if (paramLen == 5)
                ...
                if (paramLen == 4)
                {
                        ...
                        && argHelper3.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var Arg2 = argHelper2.GetUInt32(false);
                        var Arg3 = argHelper3.GetUInt32(false);
                        var result = UnityEngine.ImageConversion.EncodeArrayToPNG(Arg0,Arg1,Arg2,Arg3);
                        Puerts.ResultHelper.Set((int)data, isolate, info, result);
                        return;
                    }
                }
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_EncodeArrayToJPG(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                if (paramLen == 6)
                ...
                if (paramLen == 5)
                {
                        ...
                        && argHelper4.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var Arg3 = argHelper3.GetUInt32(false);
                        var Arg4 = argHelper4.GetUInt32(false);
                        var result = UnityEngine.ImageConversion.EncodeArrayToJPG(Arg0,Arg1,Arg2,Arg3,Arg4);
                        Puerts.ResultHelper.Set((int)data, isolate, info, result);
                        return;
                    }
                }
                if (paramLen == 4)
                {
                        ...
                        && argHelper3.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var Arg2 = argHelper2.GetUInt32(false);
                        var Arg3 = argHelper3.GetUInt32(false);
                        var result = UnityEngine.ImageConversion.EncodeArrayToJPG(Arg0,Arg1,Arg2,Arg3);
                        Puerts.ResultHelper.Set((int)data, isolate, info, result);
                        return;
                    }
                }
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_EncodeArrayToEXR(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                if (paramLen == 6)
                {
                        ...
                        && argHelper5.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var Arg3 = argHelper3.GetUInt32(false);
                        var Arg4 = argHelper4.GetUInt32(false);
                        var Arg5 = (UnityEngine.Texture2D.EXRFlags)argHelper5.GetInt32(false);
                ...
                if (paramLen == 5)
                {
                        ...
                        && argHelper4.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var Arg3 = argHelper3.GetUInt32(false);
                        var Arg4 = argHelper4.GetUInt32(false);
                        var result = UnityEngine.ImageConversion.EncodeArrayToEXR(Arg0,Arg1,Arg2,Arg3,Arg4);
                        Puerts.ResultHelper.Set((int)data, isolate, info, result);
                        return;
                    }
                }
                if (paramLen == 4)
                {
                        ...
                        && argHelper3.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var Arg2 = argHelper2.GetUInt32(false);
                        var Arg3 = argHelper3.GetUInt32(false);
                        var result = UnityEngine.ImageConversion.EncodeArrayToEXR(Arg0,Arg1,Arg2,Arg3);
                        Puerts.ResultHelper.Set((int)data, isolate, info, result);
                        return;
                    }
                }
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_EnableLegacyPngGammaRuntimeLoadBehavior(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_EnableLegacyPngGammaRuntimeLoadBehavior(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.ImageConversion.EnableLegacyPngGammaRuntimeLoadBehavior = argHelper.GetBoolean(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Methods = new System.Collections.Generic.Dictionary<Puerts.MethodKey, Puerts.V8FunctionCallback>()
                {
                    ...
                    { new Puerts.MethodKey {Name = "EncodeArrayToTGA", IsStatic = true}, F_EncodeArrayToTGA },
                    { new Puerts.MethodKey {Name = "EncodeArrayToPNG", IsStatic = true}, F_EncodeArrayToPNG },
                    { new Puerts.MethodKey {Name = "EncodeArrayToJPG", IsStatic = true}, F_EncodeArrayToJPG },
                    { new Puerts.MethodKey {Name = "EncodeArrayToEXR", IsStatic = true}, F_EncodeArrayToEXR },
                },
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    {"EnableLegacyPngGammaRuntimeLoadBehavior", new Puerts.PropertyRegisterInfo(){ IsStatic = true, Getter = G_EnableLegacyPngGammaRuntimeLoadBehavior, Setter = S_EnableLegacyPngGammaRuntimeLoadBehavior} },
                },
