...
namespace PuertsStaticWrap
{
    public static class UnityEngine_Texture2DArray_Wrap
    {
            ...
            try
            {
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new UnityEngine.Texture2DArray(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6);
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.Texture2DArray), result);
                    
                    }
                
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper3.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper4.IsMatch(Puerts.JsValueType.Boolean, null, false, false) && argHelper5.IsMatch(Puerts.JsValueType.Boolean, null, false, false) && argHelper6.IsMatch(Puerts.JsValueType.Boolean, null, false, false))
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.Texture2DArray constructor");
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_allSlices(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
...
{ new Puerts.MethodKey {Name = "Apply", IsStatic = false}, M_Apply }
                ...
                {
                    {"allSlices", new Puerts.PropertyRegisterInfo(){ IsStatic = true, Getter = G_allSlices, Setter = null} },
