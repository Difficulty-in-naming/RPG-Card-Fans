...
{
    public static class UnityEngine_Hash128_Wrap
    {
            ...
            try
            {
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new UnityEngine.Hash128(Arg0, Arg1, Arg2, Arg3);
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.Hash128), result);
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new UnityEngine.Hash128(Arg0, Arg1);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.Hash128 constructor");
        ...
        private static void M_CompareTo(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.Hash128)Puerts.Utils.GetSelf((int)data, self);
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.Hash128), false, false))
                
                    {
                
                        var Arg0 = argHelper0.Get<UnityEngine.Hash128>(false);
            ...
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var result = UnityEngine.Hash128.Parse(Arg0);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_Compute(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                ...
                
                    {
                        ...
                        var result = UnityEngine.Hash128.Compute(Arg0);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to Compute");
...
{ new Puerts.MethodKey {Name = "Compute", IsStatic = true}, F_Compute },
