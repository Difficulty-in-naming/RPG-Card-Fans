...
{
    public static class UnityEngine_TextMesh_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.TextMesh();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.TextMesh), result);
        ...
        private static void G_text(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TextMesh;
                var result = obj.text;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_offsetZ(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TextMesh;
                var result = obj.offsetZ;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_offsetZ(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TextMesh;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.offsetZ = argHelper.GetFloat(false);
        ...
        private static void S_alignment(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TextMesh;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.alignment = (UnityEngine.TextAlignment)argHelper.GetInt32(false);
        ...
        private static void S_anchor(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TextMesh;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.anchor = (UnityEngine.TextAnchor)argHelper.GetInt32(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_characterSize(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TextMesh;
                var result = obj.characterSize;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_characterSize(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TextMesh;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.characterSize = argHelper.GetFloat(false);
        ...
        private static void S_tabSize(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TextMesh;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.tabSize = argHelper.GetFloat(false);
...
{"offsetZ", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_offsetZ, Setter = S_offsetZ} },
...
{"characterSize", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_characterSize, Setter = S_characterSize} },
