...
{
    public static class FairyGUI_GLabel_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                {
                    {
                        var result = new FairyGUI.GLabel();
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.GLabel), result);
                    }
                }
            }
            catch (Exception e)
        ...
        private static void M_GetTextField(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.GLabel;
                {
                    {
