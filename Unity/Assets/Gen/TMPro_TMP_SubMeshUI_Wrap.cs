...
{
    public static class TMPro_TMP_SubMeshUI_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new TMPro.TMP_SubMeshUI();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(TMPro.TMP_SubMeshUI), result);
            ...
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var Arg0 = argHelper0.Get<TMPro.TextMeshProUGUI>(false);
                    
                        var Arg1 = argHelper1.Get<TMPro.MaterialReference>(false);
                    
                        var result = TMPro.TMP_SubMeshUI.AddSubTextObject(Arg0, Arg1);
        ...
        private static void M_GetModifiedMaterial(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.TMP_SubMeshUI;
            ...
            try
            {
            ...
            
                {
                ...
                
                    {
                        ...
                        var result = obj.GetPaddingForMaterial(Arg0);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to GetPaddingForMaterial");
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SetPivotDirty(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.TMP_SubMeshUI;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_RefreshMaterial(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.TMP_SubMeshUI;
        ...
        private static void G_fallbackSourceMaterial(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            ...
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.TMP_SubMeshUI;
                var result = obj.fallbackSourceMaterial;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
...
{ new Puerts.MethodKey {Name = "SetPivotDirty", IsStatic = false}, M_SetPivotDirty },
{ new Puerts.MethodKey {Name = "Cull", IsStatic = false}, M_Cull },
{ new Puerts.MethodKey {Name = "Rebuild", IsStatic = false}, M_Rebuild },
{ new Puerts.MethodKey {Name = "RefreshMaterial", IsStatic = false}, M_RefreshMaterial },
