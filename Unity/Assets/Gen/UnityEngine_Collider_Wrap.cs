...
{
    public static class UnityEngine_Collider_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.Collider();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.Collider), result);
            ...
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var result = obj.Raycast(Arg0, out Arg1, Arg2);
        ...
        private static void G_attachedArticulationBody(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            ...
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Collider;
                var result = obj.attachedArticulationBody;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        private static void G_hasModifiableContacts(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            ...
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Collider;
                var result = obj.hasModifiableContacts;
                Puerts.PuertsDLL.ReturnBoolean(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        private static void S_hasModifiableContacts(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Collider;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.hasModifiableContacts = argHelper.GetBoolean(false);
