...
{
    public static class UnityEngine_Vector3Int_Wrap
    {
            ...
            try
            {
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new UnityEngine.Vector3Int(Arg0, Arg1);
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.Vector3Int), result);
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new UnityEngine.Vector3Int(Arg0, Arg1, Arg2);
                ...
                
                {
            
                    {
                        ...
                        var result = new UnityEngine.Vector3Int();
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.Vector3Int constructor");
        ...
        private static void M_Set(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.Vector3Int)Puerts.Utils.GetSelf((int)data, self);
            ...
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var result = UnityEngine.Vector3Int.Min(Arg0, Arg1);
            ...
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var result = UnityEngine.Vector3Int.Scale(Arg0, Arg1);
            ...
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var result = UnityEngine.Vector3Int.FloorToInt(Arg0);
            ...
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var result = UnityEngine.Vector3Int.CeilToInt(Arg0);
            ...
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var result = UnityEngine.Vector3Int.RoundToInt(Arg0);
        ...
        private static void G_zero(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = UnityEngine.Vector3Int.zero;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        private static void G_one(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = UnityEngine.Vector3Int.one;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        private static void G_up(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = UnityEngine.Vector3Int.up;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        private static void G_down(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = UnityEngine.Vector3Int.down;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        private static void G_left(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = UnityEngine.Vector3Int.left;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        private static void G_right(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = UnityEngine.Vector3Int.right;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        private static void G_forward(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = UnityEngine.Vector3Int.forward;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        private static void G_back(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = UnityEngine.Vector3Int.back;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        private static void O_op_Multiply(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.Vector3Int), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.Vector3Int), false, false))
