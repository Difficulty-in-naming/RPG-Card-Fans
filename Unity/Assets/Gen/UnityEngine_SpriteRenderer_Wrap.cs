...
namespace PuertsStaticWrap
{
    public static class UnityEngine_SpriteRenderer_Wrap
    {
        ...
        private static void M_RegisterSpriteChangeCallback(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var Arg0 = argHelper0.Get<UnityEngine.Events.UnityAction<UnityEngine.SpriteRenderer>>(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_UnregisterSpriteChangeCallback(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.SpriteRenderer;
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {
                    { new Puerts.MethodKey {Name = "RegisterSpriteChangeCallback", IsStatic = false}, M_RegisterSpriteChangeCallback },
{ new Puerts.MethodKey {Name = "UnregisterSpriteChangeCallback", IsStatic = false}, M_UnregisterSpriteChangeCallback }
                },
