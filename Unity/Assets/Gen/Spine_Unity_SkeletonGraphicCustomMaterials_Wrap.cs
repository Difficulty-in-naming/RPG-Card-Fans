...
{
    public static class Spine_Unity_SkeletonGraphicCustomMaterials_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                {
                    {
                        var result = new Spine.Unity.SkeletonGraphicCustomMaterials();
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.Unity.SkeletonGraphicCustomMaterials), result);
                    }
                }
            }
            catch (Exception e)
        ...
        private static void G_skeletonGraphic(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Unity.SkeletonGraphicCustomMaterials;
