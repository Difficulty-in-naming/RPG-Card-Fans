            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.ParticleSystem.ForceOverLifetimeModule();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.ParticleSystem.ForceOverLifetimeModule), result);
