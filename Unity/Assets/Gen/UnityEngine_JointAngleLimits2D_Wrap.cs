...
{
    public static class UnityEngine_JointAngleLimits2D_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.JointAngleLimits2D();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.JointAngleLimits2D), result);
        ...
        private static void G_min(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.JointAngleLimits2D)Puerts.Utils.GetSelf((int)data, self);
                var result = obj.min;
