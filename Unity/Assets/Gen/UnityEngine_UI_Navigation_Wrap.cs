            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.UI.Navigation();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.UI.Navigation), result);
        ...
        private static void M_Equals(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.UI.Navigation), false, false))
