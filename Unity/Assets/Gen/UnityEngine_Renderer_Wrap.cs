...
namespace PuertsStaticWrap
{
    public static class UnityEngine_Renderer_Wrap
    {
        ...
        private static void M_ResetBounds(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_ResetLocalBounds(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Renderer;
        ...
        private static void M_SetPropertyBlock(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.MaterialPropertyBlock), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false))
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {
                    { new Puerts.MethodKey {Name = "ResetBounds", IsStatic = false}, M_ResetBounds },
{ new Puerts.MethodKey {Name = "ResetLocalBounds", IsStatic = false}, M_ResetLocalBounds },
