...
{
    public static class FairyGUI_TouchScreenKeyboard_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new FairyGUI.TouchScreenKeyboard();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.TouchScreenKeyboard), result);
        ...
        private static void M_GetInput(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.TouchScreenKeyboard;
