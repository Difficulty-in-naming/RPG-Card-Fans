    ...
    public static class UnityEngine_GradientUsageAttribute_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.GradientUsageAttribute constructor");
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_colorSpace(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.GradientUsageAttribute;
...
{"colorSpace", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_colorSpace, Setter = null} }
                },
