...
{
    public static class UnityEngine_Skybox_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.Skybox();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.Skybox), result);
        ...
        private static void G_material(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Skybox;
