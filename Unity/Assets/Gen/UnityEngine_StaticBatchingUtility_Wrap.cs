...
{
    public static class UnityEngine_StaticBatchingUtility_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.StaticBatchingUtility();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.StaticBatchingUtility), result);
        ...
        private static void F_Combine(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.GameObject[]), false, false) && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.GameObject), false, false))
