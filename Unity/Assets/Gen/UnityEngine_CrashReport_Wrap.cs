...
{
    public static class UnityEngine_CrashReport_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.CrashReport constructor");
        ...
        private static void M_Remove(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.CrashReport;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_reports(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_lastReport(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
...
{ new Puerts.MethodKey {Name = "Remove", IsStatic = false}, M_Remove }
                ...
                {
                    {"reports", new Puerts.PropertyRegisterInfo(){ IsStatic = true, Getter = G_reports, Setter = null} },
{"lastReport", new Puerts.PropertyRegisterInfo(){ IsStatic = true, Getter = G_lastReport, Setter = null} },
