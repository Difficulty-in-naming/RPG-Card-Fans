...
{
    public static class FairyGUI_UIPainter_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new FairyGUI.UIPainter();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.UIPainter), result);
        ...
        private static void M_SetSortingOrder(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.UIPainter;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_OnUpdateSource(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.UIPainter;
...
{ new Puerts.MethodKey {Name = "OnUpdateSource", IsStatic = false}, M_OnUpdateSource },
...
{"ui", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_ui, Setter = null} },
{"EM_sortingOrder", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_EM_sortingOrder, Setter = null} },
{"packageName", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_packageName, Setter = S_packageName} },
