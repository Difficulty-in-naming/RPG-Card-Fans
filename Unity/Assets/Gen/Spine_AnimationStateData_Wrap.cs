...
{
    public static class Spine_AnimationStateData_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new Spine.AnimationStateData(Arg0);
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.AnimationStateData), result);
                    }
                }
        ...
        private static void M_SetMix(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.AnimationStateData;
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to SetMix");
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_GetMix(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.AnimationStateData;
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.Get<Spine.Animation>(false);
                        var Arg1 = argHelper1.Get<Spine.Animation>(false);
                        var result = obj.GetMix(Arg0,Arg1);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {
                    { new Puerts.MethodKey {Name = "SetMix", IsStatic = false},  M_SetMix },
                    { new Puerts.MethodKey {Name = "GetMix", IsStatic = false},  M_GetMix },
