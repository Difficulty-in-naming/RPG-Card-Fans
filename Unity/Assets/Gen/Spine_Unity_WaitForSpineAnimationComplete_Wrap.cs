        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(Spine.TrackEntry), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Boolean, null, false, false))
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to Spine.Unity.WaitForSpineAnimationComplete constructor");
