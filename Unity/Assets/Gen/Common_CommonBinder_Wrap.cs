...
{
    public static class Common_CommonBinder_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                {
                    {
                        var result = new Common.CommonBinder();
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Common.CommonBinder), result);
                    }
                }
            }
            catch (Exception e)
