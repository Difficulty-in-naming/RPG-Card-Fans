    ...
    public static class UnityEngine_Screen_Wrap
    {
            ...
            try
            {
            ...
            
                {
                ...
                
                    {
                        ...
                        var Arg2 = (UnityEngine.FullScreenMode)argHelper2.GetInt32(false);
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.Boolean, null, false, false) && argHelper3.IsMatch(Puerts.JsValueType.Number, null, false, false))
            ...
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var Arg0 = argHelper0.Get<System.Collections.Generic.List<UnityEngine.DisplayInfo>>(false);
            ...
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var result = UnityEngine.Screen.MoveMainWindowTo(Arg0, Arg1);
        ...
        private static void S_fullScreen(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                UnityEngine.Screen.fullScreen = argHelper.GetBoolean(false);
        ...
        private static void S_fullScreenMode(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.Screen.fullScreenMode = (UnityEngine.FullScreenMode)argHelper.GetInt32(false);
        ...
        private static void S_autorotateToPortrait(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.Screen.autorotateToPortrait = argHelper.GetBoolean(false);
        ...
        private static void S_autorotateToPortraitUpsideDown(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.Screen.autorotateToPortraitUpsideDown = argHelper.GetBoolean(false);
        ...
        private static void S_autorotateToLandscapeLeft(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.Screen.autorotateToLandscapeLeft = argHelper.GetBoolean(false);
        ...
        private static void S_autorotateToLandscapeRight(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.Screen.autorotateToLandscapeRight = argHelper.GetBoolean(false);
        ...
        private static void S_orientation(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.Screen.orientation = (UnityEngine.ScreenOrientation)argHelper.GetInt32(false);
        ...
        private static void S_sleepTimeout(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.Screen.sleepTimeout = argHelper.GetInt32(false);
        ...
        private static void S_brightness(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.Screen.brightness = argHelper.GetFloat(false);
