...
{
    public static class Spine_Polygon_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new Spine.Polygon();
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.Polygon), result);
                    }
                }
        ...
        private static void G_Vertices(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Polygon;
