...
{
    public static class FairyGUI_StraightLineMesh_Wrap
    {
            ...
            try
            {
                ...
                
                {
            
                    {
                        ...
                        var result = new FairyGUI.StraightLineMesh();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.StraightLineMesh), result);
                ...
                
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.Color), false, false) && argHelper2.IsMatch(Puerts.JsValueType.Boolean, null, false, false))
                
                    {
                        ...
                        var result = new FairyGUI.StraightLineMesh(Arg0, Arg1, Arg2);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to FairyGUI.StraightLineMesh constructor");
        ...
        private static void M_OnPopulateMesh(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.StraightLineMesh;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_end(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.StraightLineMesh;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.end = argHelper.Get<UnityEngine.Vector3>(false);
...
{"end", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_end, Setter = S_end} },
