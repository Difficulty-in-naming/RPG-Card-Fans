...
namespace PuertsStaticWrap
{
    public static class UnityEngine_Input_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_GetPenEvent(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var result = UnityEngine.Input.GetPenEvent(Arg0);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_GetLastPenContactEvent(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        
                {
            
                    {
                        ...
                        var result = UnityEngine.Input.GetLastPenContactEvent();
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_ResetPenEvents(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_ClearLastPenContactEvent(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_penEventCount(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                
                var result = UnityEngine.Input.penEventCount;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
...
{ new Puerts.MethodKey {Name = "GetPenEvent", IsStatic = true}, F_GetPenEvent },
{ new Puerts.MethodKey {Name = "GetLastPenContactEvent", IsStatic = true}, F_GetLastPenContactEvent },
{ new Puerts.MethodKey {Name = "ResetPenEvents", IsStatic = true}, F_ResetPenEvents },
{ new Puerts.MethodKey {Name = "ClearLastPenContactEvent", IsStatic = true}, F_ClearLastPenContactEvent },
...
{"penEventCount", new Puerts.PropertyRegisterInfo(){ IsStatic = true, Getter = G_penEventCount, Setter = null} },
...
{"accelerationEvents", new Puerts.PropertyRegisterInfo(){ IsStatic = true, Getter = G_accelerationEvents, Setter = null} }
                ...
                {
                    { new Puerts.MethodKey {Name = "IsJoystickPreconfigured", IsStatic = true}, null}
                },
