...
{
    public static class FairyGUI_Utils_HtmlLink_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new FairyGUI.Utils.HtmlLink();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.Utils.HtmlLink), result);
        ...
        private static void M_Create(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Utils.HtmlLink;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SetArea(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Utils.HtmlLink;
        
                {
                ...
                
                    {
                        ...
                        obj.SetArea(Arg0, Arg1, Arg2, Arg3);
...
{ new Puerts.MethodKey {Name = "SetArea", IsStatic = false}, M_SetArea },
