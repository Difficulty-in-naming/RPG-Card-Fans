...
{
    public static class FairyGUI_Image_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                {
                    {
                        var result = new FairyGUI.Image();
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.Image), result);
                    }
                }
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(FairyGUI.NTexture), false, false))
                    {
                        ...
                        var result = new FairyGUI.Image(Arg0);
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.Image), result);
                    }
                }
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to FairyGUI.Image constructor");
            }
            catch (Exception e)
            {
        ...
        private static void M_SetNativeSize(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Image;
                {
                    {
                        obj.SetNativeSize();
                    }
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SliceFill(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Image;
        ...
        private static void S_fillMethod(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Image;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.fillMethod = (FairyGUI.FillMethod)argHelper.GetInt32(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Methods = new System.Collections.Generic.Dictionary<Puerts.MethodKey, Puerts.V8FunctionCallback>()
                {
                    ...
                    { new Puerts.MethodKey {Name = "SliceFill", IsStatic = false}, M_SliceFill },
                },
