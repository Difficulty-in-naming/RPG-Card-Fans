...
{
    public static class TMPro_TMP_Dropdown_OptionData_Wrap
    {
            ...
            try
            {
                ...
                
                {
            
                    {
                        ...
                        var result = new TMPro.TMP_Dropdown.OptionData();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(TMPro.TMP_Dropdown.OptionData), result);
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new TMPro.TMP_Dropdown.OptionData(Arg0);
                ...
                
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.Sprite), false, false))
                
                    {
                        ...
                        var result = new TMPro.TMP_Dropdown.OptionData(Arg0, Arg1);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to TMPro.TMP_Dropdown.OptionData constructor");
        ...
        private static void G_text(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.TMP_Dropdown.OptionData;
                var result = obj.text;
