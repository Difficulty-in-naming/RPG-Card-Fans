...
namespace PuertsStaticWrap
{
    public static class UnityEngine_QualitySettings_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_GetQualitySettings(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void A_activeQualityLevelChanged(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.QualitySettings.activeQualityLevelChanged += argHelper.Get<System.Action<int, int>>(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void R_activeQualityLevelChanged(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
...
{ new Puerts.MethodKey {Name = "GetQualitySettings", IsStatic = true}, F_GetQualitySettings },
{ new Puerts.MethodKey {Name = "add_activeQualityLevelChanged", IsStatic = true}, A_activeQualityLevelChanged },
{ new Puerts.MethodKey {Name = "remove_activeQualityLevelChanged", IsStatic = true},  R_activeQualityLevelChanged }
                },
...
{"activeColorSpace", new Puerts.PropertyRegisterInfo(){ IsStatic = true, Getter = G_activeColorSpace, Setter = null} }
                ...
                {
                    {"streamingMipmapsRenderersPerFrame", new Puerts.PropertyRegisterInfo(){ IsStatic = true } }
                }
            };
        }
