            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.ParticleSystem.VelocityOverLifetimeModule();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.ParticleSystem.VelocityOverLifetimeModule), result);
