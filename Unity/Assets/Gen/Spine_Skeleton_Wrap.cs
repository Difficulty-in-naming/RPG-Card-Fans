...
namespace PuertsStaticWrap
{
    public static class Spine_Skeleton_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SetDrawOrderToSetupPose(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Skeleton;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SetSlotAttachmentsToSetupPose(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Skeleton;
                {
                    {
                        obj.SetSlotAttachmentsToSetupPose();
                    }
                }
            }
            catch (Exception e)
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SetSlotAttachmentToSetupPose(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Skeleton;
                {
                    ...
                    {
                        var Arg0 = argHelper0.GetInt32(false);
                        obj.SetSlotAttachmentToSetupPose(Arg0);
                    }
                }
            }
            catch (Exception e)
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SetLocalScale(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Skeleton;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_GetLocalScale(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Skeleton;
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Methods = new System.Collections.Generic.Dictionary<Puerts.MethodKey, Puerts.V8FunctionCallback>()
                {
                    ...
                    { new Puerts.MethodKey {Name = "SetDrawOrderToSetupPose", IsStatic = false}, M_SetDrawOrderToSetupPose },
                    { new Puerts.MethodKey {Name = "SetSlotAttachmentsToSetupPose", IsStatic = false}, M_SetSlotAttachmentsToSetupPose },
                    { new Puerts.MethodKey {Name = "SetSlotAttachmentToSetupPose", IsStatic = false}, M_SetSlotAttachmentToSetupPose },
                    { new Puerts.MethodKey {Name = "GetColor", IsStatic = false}, M_GetColor },
                    { new Puerts.MethodKey {Name = "SetColor", IsStatic = false}, M_SetColor },
                    { new Puerts.MethodKey {Name = "SetLocalScale", IsStatic = false}, M_SetLocalScale },
                    { new Puerts.MethodKey {Name = "GetLocalScale", IsStatic = false}, M_GetLocalScale },
                },
