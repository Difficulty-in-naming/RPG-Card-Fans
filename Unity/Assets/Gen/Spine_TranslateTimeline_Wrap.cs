...
{
    public static class Spine_TranslateTimeline_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new Spine.TranslateTimeline(Arg0);
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.TranslateTimeline), result);
                    }
                }
        ...
        private static void M_SetFrame(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.TranslateTimeline;
        ...
        private static void G_ENTRIES(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = Spine.TranslateTimeline.ENTRIES;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
