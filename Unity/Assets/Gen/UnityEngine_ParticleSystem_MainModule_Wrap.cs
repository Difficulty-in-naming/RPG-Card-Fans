...
namespace PuertsStaticWrap
{
    public static class UnityEngine_ParticleSystem_MainModule_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_gravitySource(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.ParticleSystem.MainModule)Puerts.Utils.GetSelf((int)data, self);
                var result = obj.gravitySource;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_gravitySource(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.ParticleSystem.MainModule)Puerts.Utils.GetSelf((int)data, self);
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.gravitySource = (UnityEngine.ParticleSystemGravitySource)argHelper.GetInt32(false);
                Puerts.Utils.SetSelf((int)data, self, obj);
            }
            catch (Exception e)
            {
...
{"gravitySource", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_gravitySource, Setter = S_gravitySource} },
