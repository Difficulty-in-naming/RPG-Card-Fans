    ...
    public static class System_IO_File_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to System.IO.File constructor");
            }
            catch (Exception e)
            {
        ...
        private static void F_AppendAllText(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 3)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false)
                        && argHelper2.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Text.Encoding), false, false))
                    {
            ...
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false))
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        var result = System.IO.File.Create(Arg0);
                ...
                if (paramLen == 2)
                {
                        ...
                        && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var result = System.IO.File.Create(Arg0,Arg1);
                ...
                if (paramLen == 3)
                {
                        ...
                        && argHelper2.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        var Arg1 = argHelper1.GetInt32(false);
                        var Arg2 = (System.IO.FileOptions)argHelper2.GetInt32(false);
                        var result = System.IO.File.Create(Arg0,Arg1,Arg2);
                ...
                if (paramLen == 4)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        && argHelper2.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        && argHelper3.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Security.AccessControl.FileSecurity), false, false))
                    {
                        
                        var Arg0 = argHelper0.GetString(false);
                        var Arg1 = argHelper1.GetInt32(false);
                        var Arg2 = (System.IO.FileOptions)argHelper2.GetInt32(false);
                        var Arg3 = argHelper3.Get<System.Security.AccessControl.FileSecurity>(false);
                        var result = System.IO.File.Create(Arg0,Arg1,Arg2,Arg3);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_GetAccessControl(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false))
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        var result = System.IO.File.GetAccessControl(Arg0);
                ...
                if (paramLen == 2)
                {
                        ...
                        && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        var Arg1 = (System.Security.AccessControl.AccessControlSections)argHelper1.GetInt32(false);
                        var result = System.IO.File.GetAccessControl(Arg0,Arg1);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_SetAccessControl(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        var Arg1 = argHelper1.Get<System.Security.AccessControl.FileSecurity>(false);
                        System.IO.File.SetAccessControl(Arg0,Arg1);
        ...
        private static void F_WriteAllLines(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 2)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Collections.Generic.IEnumerable<string>), false, false))
                    {
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Methods = new System.Collections.Generic.Dictionary<Puerts.MethodKey, Puerts.V8FunctionCallback>()
                {
                    ...
                    { new Puerts.MethodKey {Name = "GetAccessControl", IsStatic = true},  F_GetAccessControl },
                    ...
                    { new Puerts.MethodKey {Name = "SetAccessControl", IsStatic = true},  F_SetAccessControl },
