...
{
    public static class Spine_Unity_SpinePathConstraint_Wrap
    {
            ...
            try
            {
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new Spine.Unity.SpinePathConstraint(Arg0, Arg1, Arg2, Arg3);
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.Unity.SpinePathConstraint), result);
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new Spine.Unity.SpinePathConstraint(Arg0, Arg1, Arg2);
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new Spine.Unity.SpinePathConstraint(Arg0, Arg1);
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new Spine.Unity.SpinePathConstraint(Arg0);
                ...
                
                {
            
                    {
                        ...
                        var result = new Spine.Unity.SpinePathConstraint();
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to Spine.Unity.SpinePathConstraint constructor");
