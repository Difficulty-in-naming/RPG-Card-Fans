            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.TextGenerationSettings();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.TextGenerationSettings), result);
        ...
        private static void M_Equals(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.TextGenerationSettings), false, false))
