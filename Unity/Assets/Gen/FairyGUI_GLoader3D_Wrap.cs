    ...
    public static class FairyGUI_GLoader3D_Wrap
    {
        ...
        private static void M_SetSpine(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(Spine.Unity.SkeletonDataAsset), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper3.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.Vector2), false, false) && argHelper4.IsMatch(Puerts.JsValueType.Boolean, null, false, false))
        ...
        private static void S_skinName(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.GLoader3D;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.skinName = argHelper.GetString(false);
