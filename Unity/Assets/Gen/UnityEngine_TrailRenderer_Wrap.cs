...
{
    public static class UnityEngine_TrailRenderer_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.TrailRenderer();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.TrailRenderer), result);
        ...
        private static void M_BakeMesh(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.Mesh), false, false) && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.Camera), false, false))
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_AddPosition(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TrailRenderer;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_AddPositions(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TrailRenderer;
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to AddPositions");
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_autodestruct(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TrailRenderer;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_autodestruct(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TrailRenderer;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_emitting(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TrailRenderer;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_emitting(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TrailRenderer;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_textureScale(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TrailRenderer;
                var result = obj.textureScale;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_textureScale(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TrailRenderer;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.textureScale = argHelper.Get<UnityEngine.Vector2>(false);
...
{ new Puerts.MethodKey {Name = "AddPosition", IsStatic = false}, M_AddPosition },
{ new Puerts.MethodKey {Name = "AddPositions", IsStatic = false}, M_AddPositions }
                },
...
{"autodestruct", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_autodestruct, Setter = S_autodestruct} },
{"emitting", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_emitting, Setter = S_emitting} },
...
{"positionCount", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_positionCount, Setter = null} },
{"textureScale", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_textureScale, Setter = S_textureScale} },
