    ...
    public static class FairyGUI_EaseManager_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to FairyGUI.EaseManager constructor");
            }
            catch (Exception e)
            {
            ...
            try
            {
                ...
                if (paramLen == 6)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        ...
                        && argHelper5.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(FairyGUI.CustomEase), false, false))
                    {
