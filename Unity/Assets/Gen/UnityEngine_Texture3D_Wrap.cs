...
{
    public static class UnityEngine_Texture3D_Wrap
    {
            ...
            try
            {
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new UnityEngine.Texture3D(Arg0, Arg1, Arg2, Arg3, Arg4);
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.Texture3D), result);
                ...
                
                    {
                        ...
                        var Arg3 = (UnityEngine.TextureFormat)argHelper3.GetInt32(false);
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new UnityEngine.Texture3D(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5);
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper3.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper4.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper5.IsMatch(Puerts.JsValueType.NativeObject, typeof(System.IntPtr), false, false))
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper3.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper4.IsMatch(Puerts.JsValueType.Boolean, null, false, false) && argHelper5.IsMatch(Puerts.JsValueType.NativeObject, typeof(System.IntPtr), false, false))
                ...
                
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper3.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper4.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper5.IsMatch(Puerts.JsValueType.NativeObject, typeof(System.IntPtr), false, false) && argHelper6.IsMatch(Puerts.JsValueType.Boolean, null, false, false))
                
                    {
                        ...
                        var result = new UnityEngine.Texture3D(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5, Arg6);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.Texture3D constructor");
        ...
        private static void M_UpdateExternalTexture(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture3D;
            ...
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var result = UnityEngine.Texture3D.CreateExternalTexture(Arg0, Arg1, Arg2, Arg3, Arg4, Arg5);
        ...
        private static void M_SetPixel(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper3.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.Color), false, false))
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper3.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.Color), false, false) && argHelper4.IsMatch(Puerts.JsValueType.Number, null, false, false))
            ...
            try
            {
            ...
            
                {
                ...
                
                    {
                        ...
                        var result = obj.GetPixel(Arg0, Arg1, Arg2, Arg3);
            ...
            try
            {
            ...
            
                {
                ...
                
                    {
                        ...
                        var result = obj.GetPixelBilinear(Arg0, Arg1, Arg2, Arg3);
