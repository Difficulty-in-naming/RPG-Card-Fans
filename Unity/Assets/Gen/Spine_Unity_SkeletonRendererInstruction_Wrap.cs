...
namespace PuertsStaticWrap
{
    public static class Spine_Unity_SkeletonRendererInstruction_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SetWithSubset(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Unity.SkeletonRendererInstruction;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_GeometryNotEqual(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.Get<Spine.Unity.SkeletonRendererInstruction>(false);
                        var Arg1 = argHelper1.Get<Spine.Unity.SkeletonRendererInstruction>(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_submeshInstructions(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Unity.SkeletonRendererInstruction;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_hasActiveClipping(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Unity.SkeletonRendererInstruction;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_hasActiveClipping(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Unity.SkeletonRendererInstruction;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.hasActiveClipping = argHelper.GetBoolean(false);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Methods = new System.Collections.Generic.Dictionary<Puerts.MethodKey, Puerts.V8FunctionCallback>()
                {
                    ...
                    { new Puerts.MethodKey {Name = "SetWithSubset", IsStatic = false},  M_SetWithSubset },
                    { new Puerts.MethodKey {Name = "Set", IsStatic = false},  M_Set },
                    { new Puerts.MethodKey {Name = "GeometryNotEqual", IsStatic = true},  F_GeometryNotEqual },
                    
                },
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    {"submeshInstructions", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_submeshInstructions, Setter = null} },
                    ...
                    {"hasActiveClipping", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_hasActiveClipping, Setter = S_hasActiveClipping} },
