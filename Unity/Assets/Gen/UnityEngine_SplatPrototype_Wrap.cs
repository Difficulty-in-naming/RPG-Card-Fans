...
{
    public static class UnityEngine_SplatPrototype_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.SplatPrototype();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.SplatPrototype), result);
        ...
        private static void G_texture(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.SplatPrototype;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_normalMap(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.SplatPrototype;
                var result = obj.normalMap;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_normalMap(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.SplatPrototype;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.normalMap = argHelper.Get<UnityEngine.Texture2D>(false);
...
{"normalMap", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_normalMap, Setter = S_normalMap} },
