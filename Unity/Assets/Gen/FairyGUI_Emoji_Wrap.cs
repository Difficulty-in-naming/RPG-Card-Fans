...
{
    public static class FairyGUI_Emoji_Wrap
    {
            ...
            try
            {
                ...
                if (paramLen == 3)
                {
                        ...
                        && argHelper2.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var result = new FairyGUI.Emoji(Arg0,Arg1,Arg2);
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.Emoji), result);
                    }
                }
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false))
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        var result = new FairyGUI.Emoji(Arg0);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to FairyGUI.Emoji constructor");
            }
            catch (Exception e)
            {
        ...
        private static void G_url(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Emoji;
                var result = obj.url;
