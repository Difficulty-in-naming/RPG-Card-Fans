...
{
    public static class SuperText_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                {
                    {
                        var result = new SuperText();
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(SuperText), result);
                    }
                }
            }
            catch (Exception e)
        ...
        private static void G_Width(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as SuperText;
