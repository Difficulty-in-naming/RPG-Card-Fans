...
{
    public static class StringParams_Wrap
    {
            ...
            try
            {

                {
                ...
                
                    {
                        ...
                        var result = new StringParams(Arg0);
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(StringParams), result);
        ...
        private static void G_Key(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as StringParams;
                var result = obj.Key;
        ...
        private static void S_Key(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                obj.Key = argHelper.GetString(false);
