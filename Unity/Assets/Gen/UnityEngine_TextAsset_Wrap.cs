...
namespace PuertsStaticWrap
{
    public static class UnityEngine_TextAsset_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_dataSize(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TextAsset;
                var result = obj.dataSize;
...
{"dataSize", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_dataSize, Setter = null} }
                },
