...
{
    public static class Spine_DrawOrderTimeline_Wrap
    {
            ...
            {
                {
                    var argHelper0 = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                    {
                        ...
                        var result = new Spine.DrawOrderTimeline(Arg0);
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.DrawOrderTimeline), result);
                    }
                }
            }
            catch (Exception e)
        ...
        private static void M_SetFrame(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.DrawOrderTimeline;
                {
                    var argHelper0 = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_DrawOrders(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.DrawOrderTimeline;
                var result = obj.DrawOrders;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_DrawOrders(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.DrawOrderTimeline;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.DrawOrders = argHelper.Get<int[][]>(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"DrawOrders", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_DrawOrders, Setter = S_DrawOrders} },
                },
