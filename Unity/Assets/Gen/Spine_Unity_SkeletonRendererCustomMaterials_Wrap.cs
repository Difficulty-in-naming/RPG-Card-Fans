...
{
    public static class Spine_Unity_SkeletonRendererCustomMaterials_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new Spine.Unity.SkeletonRendererCustomMaterials();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.Unity.SkeletonRendererCustomMaterials), result);
        ...
        private static void G_skeletonRenderer(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Unity.SkeletonRendererCustomMaterials;
