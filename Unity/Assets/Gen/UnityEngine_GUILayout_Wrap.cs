            ...
            try
            {
                if (paramLen >= 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.Texture), false, false)
                        && argHelper1.IsMatchParams(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.GUILayoutOption), 1, paramLen))
                    {
                ...
                if (paramLen >= 2)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.Texture), false, false)
                        ...
                        && argHelper2.IsMatchParams(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.GUILayoutOption), 2, paramLen))
                    {
                        var Arg0 = argHelper0.Get<UnityEngine.Texture>(false);
            ...
            try
            {
                ...
                if (paramLen >= 3)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false)
                        ...
                        && argHelper3.IsMatchParams(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.GUILayoutOption), 3, paramLen))
                    {
                        var Arg0 = argHelper0.GetString(false);
                        var Arg1 = argHelper1.GetInt32(false);
            ...
            try
            {
                ...
                if (paramLen >= 4)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false)
                        ...
                        && argHelper4.IsMatchParams(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.GUILayoutOption), 4, paramLen))
                    {
                        var Arg0 = argHelper0.GetString(false);
                        var Arg1 = argHelper1.Get<System.Char>(false);
                        var Arg2 = argHelper2.GetInt32(false);
            ...
            try
            {
                ...
                if (paramLen >= 5)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        ...
                        && argHelper5.IsMatchParams(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.GUILayoutOption), 5, paramLen))
                    {
                        var Arg0 = argHelper0.GetInt32(false);
                        var Arg1 = argHelper1.Get<UnityEngine.GUIContent[]>(false);
                        var Arg2 = argHelper2.Get<bool[]>(false);
            ...
            try
            {
                ...
                if (paramLen >= 6)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.Vector2), false, false)
                        ...
                        && argHelper6.IsMatchParams(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.GUILayoutOption), 6, paramLen))
                    {
                        var Arg0 = argHelper0.Get<UnityEngine.Vector2>(false);
                        var Arg1 = argHelper1.GetBoolean(false);
                        var Arg2 = argHelper2.GetBoolean(false);
