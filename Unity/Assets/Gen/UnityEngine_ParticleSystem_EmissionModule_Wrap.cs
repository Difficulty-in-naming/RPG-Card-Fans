            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.ParticleSystem.EmissionModule();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.ParticleSystem.EmissionModule), result);
        ...
        private static void M_SetBursts(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.ParticleSystem.Burst[]), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false))
