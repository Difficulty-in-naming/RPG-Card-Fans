...
{
    public static class Spine_EventData_Wrap
    {
            ...
            {
                {
                    var argHelper0 = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                    {
                        ...
                        var result = new Spine.EventData(Arg0);
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.EventData), result);
                    }
                }
            }
            catch (Exception e)
        ...
        private static void M_ToString(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.EventData;
                {
                    {
