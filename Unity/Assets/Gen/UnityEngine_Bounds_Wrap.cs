...
{
    public static class UnityEngine_Bounds_Wrap
    {
            ...
            try
            {
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new UnityEngine.Bounds(Arg0, Arg1);
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.Bounds), result);
                ...
                
                {
            
                    {
                        ...
                        var result = new UnityEngine.Bounds();
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.Bounds constructor");
        ...
        private static void M_GetHashCode(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.Bounds)Puerts.Utils.GetSelf((int)data, self);
        ...
        private static void M_Equals(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.Bounds), false, false))
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_Encapsulate(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.Bounds)Puerts.Utils.GetSelf((int)data, self);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to Encapsulate");
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_Expand(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.Bounds)Puerts.Utils.GetSelf((int)data, self);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to Expand");
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_Intersects(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.Bounds)Puerts.Utils.GetSelf((int)data, self);
        
                {
                ...
                
                    {
                        ...
                        var result = obj.Intersects(Arg0);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_IntersectRay(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.Bounds)Puerts.Utils.GetSelf((int)data, self);
            ...
            
                {
                ...
                
                    {
                        ...
                        var result = obj.IntersectRay(Arg0);
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.Ray), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, true, true))
                
                    {
                        ...
                        var result = obj.IntersectRay(Arg0, out Arg1);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to IntersectRay");
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SqrDistance(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (UnityEngine.Bounds)Puerts.Utils.GetSelf((int)data, self);
        
                {
                ...
                
                    {
                        ...
                        var result = obj.SqrDistance(Arg0);
...
{ new Puerts.MethodKey {Name = "Encapsulate", IsStatic = false}, M_Encapsulate },
{ new Puerts.MethodKey {Name = "Expand", IsStatic = false}, M_Expand },
{ new Puerts.MethodKey {Name = "Intersects", IsStatic = false}, M_Intersects },
{ new Puerts.MethodKey {Name = "IntersectRay", IsStatic = false}, M_IntersectRay },
{ new Puerts.MethodKey {Name = "ToString", IsStatic = false}, M_ToString },
{ new Puerts.MethodKey {Name = "Contains", IsStatic = false}, M_Contains },
{ new Puerts.MethodKey {Name = "SqrDistance", IsStatic = false}, M_SqrDistance },
