...
{
    public static class Spine_Unity_SpineAnimation_Wrap
    {
            ...
            try
            {
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new Spine.Unity.SpineAnimation(Arg0, Arg1, Arg2, Arg3);
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.Unity.SpineAnimation), result);
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new Spine.Unity.SpineAnimation(Arg0, Arg1, Arg2);
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new Spine.Unity.SpineAnimation(Arg0, Arg1);
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new Spine.Unity.SpineAnimation(Arg0);
                ...
                
                {
            
                    {
                        ...
                        var result = new Spine.Unity.SpineAnimation();
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to Spine.Unity.SpineAnimation constructor");
