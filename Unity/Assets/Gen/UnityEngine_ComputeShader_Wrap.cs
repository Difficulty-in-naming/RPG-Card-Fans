...
{
    public static class UnityEngine_ComputeShader_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.ComputeShader constructor");
        ...
        private static void M_FindKernel(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var result = obj.FindKernel(Arg0);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_HasKernel(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.ComputeShader;
            ...
            try
            {
            ...
            
                {
                ...
                
                    {
                        ...
                        obj.SetTexture(Arg0, Arg1, Arg2, Arg3);
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.Texture), false, false))
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.Texture), false, false))
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.RenderTexture), false, false) && argHelper3.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper4.IsMatch(Puerts.JsValueType.Number, null, false, false))
                
                    {
                        ...
                        var Arg4 = (UnityEngine.Rendering.RenderTextureSubElement)argHelper4.GetInt32(false);
                    
                        obj.SetTexture(Arg0, Arg1, Arg2, Arg3, Arg4);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SetTextureFromGlobal(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.ComputeShader;
            ...
            
                {
                ...
                
                    {
                        ...
                        obj.SetTextureFromGlobal(Arg0, Arg1, Arg2);
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false))
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to SetTextureFromGlobal");
        ...
        private static void M_SetBuffer(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.ComputeBuffer), false, false))
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.GraphicsBuffer), false, false))
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.ComputeBuffer), false, false))
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.GraphicsBuffer), false, false))
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_GetKernelThreadGroupSizes(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.ComputeShader;
        
                {
                ...
                
                    {
                        ...
                        var Arg1 = argHelper1.GetUInt32(true);
                    
                        var Arg2 = argHelper2.GetUInt32(true);
                    
                        var Arg3 = argHelper3.GetUInt32(true);
                    
                        obj.GetKernelThreadGroupSizes(Arg0, out Arg1, out Arg2, out Arg3);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_Dispatch(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.ComputeShader;
        ...
        private static void M_SetFloats(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false) && argHelper1.IsMatchParams(Puerts.JsValueType.Number, null, 1, paramLen))
                
                    {
                
                        var Arg0 = argHelper0.GetString(false);
                    
                        var Arg1 = argHelper1.GetParams<float>(info, 1, paramLen);
                    
                        obj.SetFloats(Arg0, Arg1);
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatchParams(Puerts.JsValueType.Number, null, 1, paramLen))
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to SetFloats");
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SetInts(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.ComputeShader;
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to SetInts");
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_DispatchIndirect(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.ComputeShader;
            ...
            
                {
                ...
                
                    {
                        ...
                        obj.DispatchIndirect(Arg0, Arg1, Arg2);
            ...
            
                {
                ...
                
                    {
                        ...
                        obj.DispatchIndirect(Arg0, Arg1);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to DispatchIndirect");
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {
                    { new Puerts.MethodKey {Name = "FindKernel", IsStatic = false}, M_FindKernel },
{ new Puerts.MethodKey {Name = "HasKernel", IsStatic = false}, M_HasKernel },
...
{ new Puerts.MethodKey {Name = "SetTextureFromGlobal", IsStatic = false}, M_SetTextureFromGlobal },
{ new Puerts.MethodKey {Name = "SetBuffer", IsStatic = false}, M_SetBuffer },
{ new Puerts.MethodKey {Name = "GetKernelThreadGroupSizes", IsStatic = false}, M_GetKernelThreadGroupSizes },
{ new Puerts.MethodKey {Name = "Dispatch", IsStatic = false}, M_Dispatch },
...
{ new Puerts.MethodKey {Name = "DispatchIndirect", IsStatic = false}, M_DispatchIndirect }
                },
