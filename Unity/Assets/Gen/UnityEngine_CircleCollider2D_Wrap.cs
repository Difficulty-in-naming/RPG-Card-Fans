...
{
    public static class UnityEngine_CircleCollider2D_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.CircleCollider2D();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.CircleCollider2D), result);
        ...
        private static void G_radius(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.CircleCollider2D;
