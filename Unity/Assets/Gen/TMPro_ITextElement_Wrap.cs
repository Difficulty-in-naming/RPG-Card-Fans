...
{
    public static class TMPro_ITextElement_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to TMPro.ITextElement constructor");
            }
            catch (Exception e)
            {
        ...
        private static void M_Rebuild(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.ITextElement;
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {
                    {"sharedMaterial", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_sharedMaterial, Setter = null} },
