...
{
    public static class TMPro_TMP_ScrollbarEventHandler_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new TMPro.TMP_ScrollbarEventHandler();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(TMPro.TMP_ScrollbarEventHandler), result);
        ...
        private static void M_OnPointerClick(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.TMP_ScrollbarEventHandler;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_isSelected(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.TMP_ScrollbarEventHandler;
                var result = obj.isSelected;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_isSelected(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.TMP_ScrollbarEventHandler;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.isSelected = argHelper.GetBoolean(false);
...
{ new Puerts.MethodKey {Name = "OnDeselect", IsStatic = false}, M_OnDeselect }
                ...
                {
                    {"isSelected", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_isSelected, Setter = S_isSelected} }
                },
