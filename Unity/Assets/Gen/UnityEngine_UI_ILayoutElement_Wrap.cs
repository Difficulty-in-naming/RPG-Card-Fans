...
{
    public static class UnityEngine_UI_ILayoutElement_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.UI.ILayoutElement constructor");
            }
            catch (Exception e)
            {
        ...
        private static void M_CalculateLayoutInputHorizontal(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.ILayoutElement;
                {
                    {
