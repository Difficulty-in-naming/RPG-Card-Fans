...
namespace PuertsStaticWrap
{
    public static class Puerts_JsEnv_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(Puerts.ILoader), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false))
                ...
                
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(Puerts.ILoader), false, false) && argHelper1.IsMatch(Puerts.JsValueType.NativeObject, typeof(System.IntPtr), false, false) && argHelper2.IsMatch(Puerts.JsValueType.NativeObject, typeof(System.IntPtr), false, false))
        ...
        private static void M_ExecuteModule(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_OnJsEnvCreate(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                
                var result = Puerts.JsEnv.OnJsEnvCreate;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_OnJsEnvCreate(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                Puerts.JsEnv.OnJsEnvCreate = argHelper.Get<Puerts.JsEnv.JsEnvCreateCallback>(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_OnJsEnvDispose(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                
                var result = Puerts.JsEnv.OnJsEnvDispose;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_OnJsEnvDispose(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                Puerts.JsEnv.OnJsEnvDispose = argHelper.Get<Puerts.JsEnv.JsEnvDisposeCallback>(false);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {
                    { new Puerts.MethodKey {Name = "ExecuteModule", IsStatic = false}, M_ExecuteModule },
...
{"OnJsEnvCreate", new Puerts.PropertyRegisterInfo(){ IsStatic = true, Getter = G_OnJsEnvCreate, Setter = S_OnJsEnvCreate} },
{"OnJsEnvDispose", new Puerts.PropertyRegisterInfo(){ IsStatic = true, Getter = G_OnJsEnvDispose, Setter = S_OnJsEnvDispose} },
