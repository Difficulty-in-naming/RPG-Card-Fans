...
namespace PuertsStaticWrap
{
    public static class UnityEngine_BillboardAsset_Wrap
    {
        ...
        private static void M_GetImageTexCoords(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SetImageTexCoords(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.BillboardAsset;
        ...
        private static void M_SetVertices(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.Vector2[]), false, false))
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_imageCount(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.BillboardAsset;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_indexCount(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.BillboardAsset;
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {
                    { new Puerts.MethodKey {Name = "GetImageTexCoords", IsStatic = false}, M_GetImageTexCoords },
{ new Puerts.MethodKey {Name = "SetImageTexCoords", IsStatic = false}, M_SetImageTexCoords },
...
{"imageCount", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_imageCount, Setter = null} },
{"vertexCount", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_vertexCount, Setter = null} },
{"indexCount", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_indexCount, Setter = null} },
