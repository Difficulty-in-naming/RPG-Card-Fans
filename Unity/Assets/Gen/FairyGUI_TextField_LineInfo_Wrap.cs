...
{
    public static class FairyGUI_TextField_LineInfo_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new FairyGUI.TextField.LineInfo();
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.TextField.LineInfo), result);
                    }
                }
        ...
        private static void F_Borrow(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = FairyGUI.TextField.LineInfo.Borrow();
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_Return(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(FairyGUI.TextField.LineInfo), false, false))
                    {
                        
                        var Arg0 = argHelper0.Get<FairyGUI.TextField.LineInfo>(false);
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Collections.Generic.List<FairyGUI.TextField.LineInfo>), false, false))
                    {
                        
                        var Arg0 = argHelper0.Get<System.Collections.Generic.List<FairyGUI.TextField.LineInfo>>(false);
                        FairyGUI.TextField.LineInfo.Return(Arg0);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to Return");
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        private static void G_width(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.TextField.LineInfo;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_charCount(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.TextField.LineInfo;
                var result = obj.charCount;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_charCount(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.TextField.LineInfo;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.charCount = argHelper.GetInt16(false);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                {
                    { new Puerts.MethodKey {Name = "Borrow", IsStatic = true},  F_Borrow },
                    { new Puerts.MethodKey {Name = "Return", IsStatic = true},  F_Return },
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"charCount", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_charCount, Setter = S_charCount} },
