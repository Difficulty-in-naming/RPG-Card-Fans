    ...
    public static class FairyGUI_GRoot_Wrap
    {
            ...
            try
            {
            ...
            
                {
                ...
                
                    {
                        ...
                        var Arg2 = (FairyGUI.UIContentScaler.ScreenMatchMode)argHelper2.GetInt32(false);
            ...
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var Arg0 = argHelper0.Get<FairyGUI.Window>(false);
        ...
        private static void M_HideWindowImmediately(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(FairyGUI.Window), false, false))
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(FairyGUI.Window), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Boolean, null, false, false))
        ...
        private static void M_ShowPopup(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(FairyGUI.GObject), false, false) && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(FairyGUI.GObject), false, false))
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(FairyGUI.GObject), false, false) && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(FairyGUI.GObject), false, false) && argHelper2.IsMatch(Puerts.JsValueType.Number, null, false, false))
                
                    {
                        ...
                        var Arg2 = (FairyGUI.PopupDirection)argHelper2.GetInt32(false);
        ...
        private static void S_focus(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                obj.focus = argHelper.Get<FairyGUI.GObject>(false);
