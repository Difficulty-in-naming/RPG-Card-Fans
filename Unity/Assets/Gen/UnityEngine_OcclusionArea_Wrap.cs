...
{
    public static class UnityEngine_OcclusionArea_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.OcclusionArea();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.OcclusionArea), result);
        ...
        private static void G_center(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.OcclusionArea;
