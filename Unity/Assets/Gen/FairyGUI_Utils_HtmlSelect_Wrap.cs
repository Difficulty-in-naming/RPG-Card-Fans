...
{
    public static class FairyGUI_Utils_HtmlSelect_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new FairyGUI.Utils.HtmlSelect();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.Utils.HtmlSelect), result);
        ...
        private static void M_Create(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Utils.HtmlSelect;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_comboBox(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Utils.HtmlSelect;
                var result = obj.comboBox;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_CHANGED_EVENT(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                
                var result = FairyGUI.Utils.HtmlSelect.CHANGED_EVENT;
        ...
        private static void G_resource(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = FairyGUI.Utils.HtmlSelect.resource;
                Puerts.PuertsDLL.ReturnString(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        private static void S_resource(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                FairyGUI.Utils.HtmlSelect.resource = argHelper.GetString(false);
...
{ new Puerts.MethodKey {Name = "Dispose", IsStatic = false}, M_Dispose }
                ...
                {
                    {"comboBox", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_comboBox, Setter = null} },
...
{"CHANGED_EVENT", new Puerts.PropertyRegisterInfo(){ IsStatic = true, Getter = G_CHANGED_EVENT, Setter = null} },
{"resource", new Puerts.PropertyRegisterInfo(){ IsStatic = true, Getter = G_resource, Setter = S_resource} }
                },
