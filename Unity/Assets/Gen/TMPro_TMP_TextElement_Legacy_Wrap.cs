...
{
    public static class TMPro_TMP_TextElement_Legacy_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new TMPro.TMP_TextElement_Legacy();
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(TMPro.TMP_TextElement_Legacy), result);
                    }
                }
        ...
        private static void G_id(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.TMP_TextElement_Legacy;
                var result = obj.id;
        ...
        private static void S_id(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                obj.id = argHelper.GetInt32(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_yOffset(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.TMP_TextElement_Legacy;
                var result = obj.yOffset;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_yOffset(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.TMP_TextElement_Legacy;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.yOffset = argHelper.GetFloat(false);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"yOffset", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_yOffset, Setter = S_yOffset} },
