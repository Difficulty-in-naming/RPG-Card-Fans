            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.CustomRenderTextureUpdateZone();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.CustomRenderTextureUpdateZone), result);
