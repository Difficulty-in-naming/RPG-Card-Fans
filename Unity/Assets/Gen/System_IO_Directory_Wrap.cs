    ...
    public static class System_IO_Directory_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to System.IO.Directory constructor");
            }
            catch (Exception e)
            {
            ...
            try
            {
                ...
                if (paramLen == 2)
                {
                        ...
                        && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Security.AccessControl.DirectorySecurity), false, false))
                    {
                        ...
                        var result = System.IO.Directory.CreateDirectory(Arg0,Arg1);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to CreateDirectory");
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        var Arg1 = argHelper1.Get<System.Security.AccessControl.DirectorySecurity>(false);
                        System.IO.Directory.SetAccessControl(Arg0,Arg1);
            ...
            try
            {
                ...
                if (paramLen == 2)
                {
                        ...
                        && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var result = System.IO.Directory.GetAccessControl(Arg0,Arg1);
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false))
                    {
                        ...
                        var Arg0 = argHelper0.GetString(false);
                        var result = System.IO.Directory.GetAccessControl(Arg0);
