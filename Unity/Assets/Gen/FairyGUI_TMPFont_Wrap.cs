...
{
    public static class FairyGUI_TMPFont_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                {
                    {
                        var result = new FairyGUI.TMPFont();
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.TMPFont), result);
                    }
                }
            }
            catch (Exception e)
        ...
        private static void M_Dispose(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.TMPFont;
                {
                    {
                        obj.Dispose();
                    }
