...
{
    public static class UnityEngine_UI_Dropdown_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.UI.Dropdown constructor");
        ...
        private static void M_SetValueWithoutNotify(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Dropdown;
        ...
        private static void M_AddOptions(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Collections.Generic.List<UnityEngine.UI.Dropdown.OptionData>), false, false))
                
                    {
                
                        var Arg0 = argHelper0.Get<System.Collections.Generic.List<UnityEngine.UI.Dropdown.OptionData>>(false);
        ...
        private static void S_captionText(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Dropdown;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.captionText = argHelper.Get<UnityEngine.UI.Text>(false);
        ...
        private static void S_itemText(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Dropdown;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.itemText = argHelper.Get<UnityEngine.UI.Text>(false);
        ...
        private static void S_options(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Dropdown;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.options = argHelper.Get<System.Collections.Generic.List<UnityEngine.UI.Dropdown.OptionData>>(false);
        ...
        private static void S_onValueChanged(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.Dropdown;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.onValueChanged = argHelper.Get<UnityEngine.UI.Dropdown.DropdownEvent>(false);
