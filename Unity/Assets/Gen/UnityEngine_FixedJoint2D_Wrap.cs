...
{
    public static class UnityEngine_FixedJoint2D_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.FixedJoint2D();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.FixedJoint2D), result);
        ...
        private static void G_dampingRatio(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.FixedJoint2D;
