...
{
    public static class TMPro_TMP_Sprite_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                {
                    {
                        var result = new TMPro.TMP_Sprite();
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(TMPro.TMP_Sprite), result);
                    }
                }
            }
            catch (Exception e)
        ...
        private static void G_name(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.TMP_Sprite;
                var result = obj.name;
        ...
        private static void S_unicode(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.TMP_Sprite;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.unicode = argHelper.GetInt32(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
