...
{
    public static class UnityEngine_UI_LayoutRebuilder_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.UI.LayoutRebuilder();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.UI.LayoutRebuilder), result);
        ...
        private static void M_IsDestroyed(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.UI.LayoutRebuilder;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_ForceRebuildLayoutImmediate(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_MarkLayoutForRebuild(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
...
{ new Puerts.MethodKey {Name = "ForceRebuildLayoutImmediate", IsStatic = true}, F_ForceRebuildLayoutImmediate },
{ new Puerts.MethodKey {Name = "Rebuild", IsStatic = false}, M_Rebuild },
{ new Puerts.MethodKey {Name = "MarkLayoutForRebuild", IsStatic = true}, F_MarkLayoutForRebuild },
