...
{
    public static class Spine_IkConstraintTimeline_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new Spine.IkConstraintTimeline(Arg0);
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.IkConstraintTimeline), result);
                    }
                }
        ...
        private static void M_SetFrame(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.IkConstraintTimeline;
                ...
                
                {
                    ...
                    
                    {
                        ...
                        obj.SetFrame(Arg0,Arg1,Arg2,Arg3,Arg4,Arg5,Arg6);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_IkConstraintIndex(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.IkConstraintTimeline;
                var result = obj.IkConstraintIndex;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_IkConstraintIndex(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.IkConstraintTimeline;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.IkConstraintIndex = argHelper.GetInt32(false);
        ...
        private static void G_ENTRIES(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = Spine.IkConstraintTimeline.ENTRIES;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"IkConstraintIndex", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_IkConstraintIndex, Setter = S_IkConstraintIndex} },
