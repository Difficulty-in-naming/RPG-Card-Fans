...
{
    public static class FairyGUI_GMovieClip_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new FairyGUI.GMovieClip();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.GMovieClip), result);
        ...
        private static void M_Rewind(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.GMovieClip;
            ...
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var Arg0 = argHelper0.Get<FairyGUI.GMovieClip>(false);
