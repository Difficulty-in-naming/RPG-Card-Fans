...
namespace PuertsStaticWrap
{
    public static class Spine_VertexAttachment_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to Spine.VertexAttachment constructor");
            }
            catch (Exception e)
            {
            ...
            try
            {
                ...
                if (paramLen == 6)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(Spine.Slot), false, false)
                        ...
                        && argHelper3.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(float[]), false, false)
