...
{
    public static class UnityEngine_MeshFilter_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.MeshFilter();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.MeshFilter), result);
        ...
        private static void G_sharedMesh(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.MeshFilter;
