...
{
    public static class FairyGUI_SwipeGesture_Wrap
    {
            ...
            try
            {

                {
                ...
                
                    {
                        ...
                        var result = new FairyGUI.SwipeGesture(Arg0);
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.SwipeGesture), result);
        ...
        private static void M_Dispose(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.SwipeGesture;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_onMove(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.SwipeGesture;
                var result = obj.onMove;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_actionDistance(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.SwipeGesture;
                var result = obj.actionDistance;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_actionDistance(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.SwipeGesture;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.actionDistance = argHelper.GetInt32(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_snapping(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.SwipeGesture;
                var result = obj.snapping;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_snapping(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.SwipeGesture;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.snapping = argHelper.GetBoolean(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_ACTION_DISTANCE(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                
                var result = FairyGUI.SwipeGesture.ACTION_DISTANCE;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_ACTION_DISTANCE(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                FairyGUI.SwipeGesture.ACTION_DISTANCE = argHelper.GetInt32(false);
...
{"onMove", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_onMove, Setter = null} },
...
{"actionDistance", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_actionDistance, Setter = S_actionDistance} },
{"snapping", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_snapping, Setter = S_snapping} },
{"ACTION_DISTANCE", new Puerts.PropertyRegisterInfo(){ IsStatic = true, Getter = G_ACTION_DISTANCE, Setter = S_ACTION_DISTANCE} }
                },
