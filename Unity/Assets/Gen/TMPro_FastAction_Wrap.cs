...
{
    public static class TMPro_FastAction_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                {
                    {
                        var result = new TMPro.FastAction();
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(TMPro.FastAction), result);
                    }
                }
            }
            catch (Exception e)
        ...
        private static void M_Add(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.FastAction;
                {
