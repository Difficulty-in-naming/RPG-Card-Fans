...
{
    public static class Spine_ColorTimeline_Wrap
    {
            ...
            try
            {

                {
                ...
                
                    {
                        ...
                        var result = new Spine.ColorTimeline(Arg0);
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.ColorTimeline), result);
        ...
        private static void M_SetFrame(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.ColorTimeline;
        ...
        private static void G_ENTRIES(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = Spine.ColorTimeline.ENTRIES;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
