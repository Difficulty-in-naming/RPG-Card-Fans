...
{
    public static class Spine_PathConstraint_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 2)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(Spine.PathConstraintData), false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(Spine.Skeleton), false, false))
                    {
                        
                        var Arg0 = argHelper0.Get<Spine.PathConstraintData>(false);
                        var Arg1 = argHelper1.Get<Spine.Skeleton>(false);
                        var result = new Spine.PathConstraint(Arg0,Arg1);
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.PathConstraint), result);
                    }
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(Spine.PathConstraint), false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(Spine.Skeleton), false, false))
                    {
                        
                        var Arg0 = argHelper0.Get<Spine.PathConstraint>(false);
                        var Arg1 = argHelper1.Get<Spine.Skeleton>(false);
                        var result = new Spine.PathConstraint(Arg0,Arg1);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to Spine.PathConstraint constructor");
            }
            catch (Exception e)
            {
        ...
        private static void M_Apply(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.PathConstraint;
        ...
        private static void S_Target(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.PathConstraint;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.Target = argHelper.Get<Spine.Slot>(false);
