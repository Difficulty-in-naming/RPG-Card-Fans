...
{
    public static class UnityEngine_TrackedReference_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.TrackedReference constructor");
        ...
        private static void M_Equals(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.TrackedReference;
            ...
            try
            {
        
                {
                ...
                
                    {
                        ...
                        var arg0 = argHelper0.Get<UnityEngine.TrackedReference>(false);
                     
                        var arg1 = argHelper1.Get<UnityEngine.TrackedReference>(false);
