...
{
    public static class Spine_ShearTimeline_Wrap
    {
            ...
            {
                {
                    var argHelper0 = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                    {
                        ...
                        var result = new Spine.ShearTimeline(Arg0);
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.ShearTimeline), result);
                    }
                }
            }
            catch (Exception e)
        ...
        private static void M_Apply(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.ShearTimeline;
                if (paramLen == 7)
                {
                    var argHelper0 = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(Spine.Skeleton), false, false)
                        ...
                        && argHelper3.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(Spine.ExposedList<Spine.Event>), false, false)
