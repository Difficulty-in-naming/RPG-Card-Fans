...
{
    public static class FairyGUI_Transition_Wrap
    {
            ...
            try
            {

                {
                ...
                
                    {
                        ...
                        var result = new FairyGUI.Transition(Arg0);
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.Transition), result);
        ...
        private static void M_Play(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Transition;
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject | Puerts.JsValueType.Function, typeof(FairyGUI.PlayCompleteCallback), false, false))
                
                    {
                
                        var Arg0 = argHelper0.Get<FairyGUI.PlayCompleteCallback>(false);
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject | Puerts.JsValueType.Function, typeof(FairyGUI.PlayCompleteCallback), false, false))
                
                    {
                        ...
                        var Arg2 = argHelper2.Get<FairyGUI.PlayCompleteCallback>(false);
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper2.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper3.IsMatch(Puerts.JsValueType.Number, null, false, false) && argHelper4.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject | Puerts.JsValueType.Function, typeof(FairyGUI.PlayCompleteCallback), false, false))
                
                    {
                        ...
                        var Arg4 = argHelper4.Get<FairyGUI.PlayCompleteCallback>(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_PlayReverse(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Transition;
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to PlayReverse");
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_ChangePlayTimes(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Transition;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SetAutoPlay(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Transition;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_SetHook(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Transition;
        
                {
                ...
                
                    {
                        ...
                        var Arg1 = argHelper1.Get<FairyGUI.TransitionHook>(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_ClearHooks(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Transition;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_GetLabelTime(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Transition;
        
                {
                ...
                
                    {
                        ...
                        var result = obj.GetLabelTime(Arg0);
            ...
            try
            {
        ...
        
                {
                ...
                
                    {
                        ...
                        var Arg0 = argHelper0.Get<FairyGUI.GTweener>(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_invalidateBatchingEveryFrame(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Transition;
                var result = obj.invalidateBatchingEveryFrame;
                Puerts.PuertsDLL.ReturnBoolean(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_invalidateBatchingEveryFrame(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Transition;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.invalidateBatchingEveryFrame = argHelper.GetBoolean(false);
...
{ new Puerts.MethodKey {Name = "PlayReverse", IsStatic = false}, M_PlayReverse },
{ new Puerts.MethodKey {Name = "ChangePlayTimes", IsStatic = false}, M_ChangePlayTimes },
{ new Puerts.MethodKey {Name = "SetAutoPlay", IsStatic = false}, M_SetAutoPlay },
...
{ new Puerts.MethodKey {Name = "SetHook", IsStatic = false}, M_SetHook },
{ new Puerts.MethodKey {Name = "ClearHooks", IsStatic = false}, M_ClearHooks },
...
{ new Puerts.MethodKey {Name = "GetLabelTime", IsStatic = false}, M_GetLabelTime },
...
{"playing", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_playing, Setter = null} },
...
{"invalidateBatchingEveryFrame", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_invalidateBatchingEveryFrame, Setter = S_invalidateBatchingEveryFrame} }
                },
