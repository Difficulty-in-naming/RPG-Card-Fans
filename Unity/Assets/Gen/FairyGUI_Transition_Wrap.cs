            ...
            try
            {
                ...
                if (paramLen == 3)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        ...
                        && argHelper2.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject | Puerts.JsValueType.Function, typeof(FairyGUI.PlayCompleteCallback), false, false))
                    {
                ...
                if (paramLen == 5)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        ...
                        && argHelper4.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject | Puerts.JsValueType.Function, typeof(FairyGUI.PlayCompleteCallback), false, false))
                    {
                        var Arg0 = argHelper0.GetInt32(false);
                        var Arg1 = argHelper1.GetFloat(false);
