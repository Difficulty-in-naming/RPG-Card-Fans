...
{
    public static class TMPro_TMP_Dropdown_OptionDataList_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new TMPro.TMP_Dropdown.OptionDataList();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(TMPro.TMP_Dropdown.OptionDataList), result);
        ...
        private static void G_options(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as TMPro.TMP_Dropdown.OptionDataList;
