...
{
    public static class UnityEngine_SphereCollider_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.SphereCollider();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.SphereCollider), result);
        ...
        private static void G_center(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.SphereCollider;
