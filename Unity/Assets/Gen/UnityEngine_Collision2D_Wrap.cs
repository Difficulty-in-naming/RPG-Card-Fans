...
{
    public static class UnityEngine_Collision2D_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.Collision2D();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.Collision2D), result);
        ...
        private static void M_GetContact(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Collision2D;
