...
{
    public static class Spine_Unity_AnimationReferenceAsset_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new Spine.Unity.AnimationReferenceAsset();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.Unity.AnimationReferenceAsset), result);
        ...
        private static void M_Initialize(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Unity.AnimationReferenceAsset;
