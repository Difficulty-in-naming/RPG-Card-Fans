...
{
    public static class UnityEngine_ScriptableObject_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.ScriptableObject();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.ScriptableObject), result);
            ...
            try
            {
            ...
            
                {
                ...
                
                    {
                        ...
                        var result = UnityEngine.ScriptableObject.CreateInstance(Arg0);
