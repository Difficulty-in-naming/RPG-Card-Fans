...
{
    public static class TMPro_Extents_Wrap
    {
            ...
            try
            {
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new TMPro.Extents(Arg0, Arg1);
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(TMPro.Extents), result);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to TMPro.Extents constructor");
        ...
        private static void M_ToString(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (TMPro.Extents)Puerts.Utils.GetSelf((int)data, self);
