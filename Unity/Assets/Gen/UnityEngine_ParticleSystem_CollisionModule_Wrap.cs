            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.ParticleSystem.CollisionModule();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.ParticleSystem.CollisionModule), result);
