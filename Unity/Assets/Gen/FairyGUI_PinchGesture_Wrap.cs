...
{
    public static class FairyGUI_PinchGesture_Wrap
    {
            ...
            {
                {
                    var argHelper0 = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                    {
                        ...
                        var result = new FairyGUI.PinchGesture(Arg0);
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.PinchGesture), result);
                    }
                }
            }
            catch (Exception e)
        ...
        private static void M_Dispose(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.PinchGesture;
                {
                    {
                        obj.Dispose();
                    }
