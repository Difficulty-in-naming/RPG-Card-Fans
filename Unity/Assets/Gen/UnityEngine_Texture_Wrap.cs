    ...
    public static class UnityEngine_Texture_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.Texture constructor");
            }
            catch (Exception e)
            {
        ...
        private static void S_masterTextureLimit(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                UnityEngine.Texture.masterTextureLimit = argHelper.GetInt32(false);
        ...
        private static void S_anisotropicFiltering(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.Texture.anisotropicFiltering = (UnityEngine.AnisotropicFiltering)argHelper.GetInt32(false);
        ...
        private static void S_wrapMode(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.wrapMode = (UnityEngine.TextureWrapMode)argHelper.GetInt32(false);
        ...
        private static void S_wrapModeU(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.wrapModeU = (UnityEngine.TextureWrapMode)argHelper.GetInt32(false);
        ...
        private static void S_wrapModeV(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.wrapModeV = (UnityEngine.TextureWrapMode)argHelper.GetInt32(false);
        ...
        private static void S_wrapModeW(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.wrapModeW = (UnityEngine.TextureWrapMode)argHelper.GetInt32(false);
        ...
        private static void S_filterMode(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.filterMode = (UnityEngine.FilterMode)argHelper.GetInt32(false);
        ...
        private static void S_anisoLevel(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.anisoLevel = argHelper.GetInt32(false);
        ...
        private static void S_mipMapBias(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.mipMapBias = argHelper.GetFloat(false);
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_imageContentsHash(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture;
                var result = obj.imageContentsHash;
                Puerts.ResultHelper.Set((int)data, isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_imageContentsHash(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.Texture;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.imageContentsHash = argHelper.Get<UnityEngine.Hash128>(false);
        ...
        private static void S_streamingTextureForceLoadAll(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.Texture.streamingTextureForceLoadAll = argHelper.GetBoolean(false);
        ...
        private static void S_streamingTextureDiscardUnusedMips(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.Texture.streamingTextureDiscardUnusedMips = argHelper.GetBoolean(false);
        ...
        private static void S_allowThreadedTextureCreation(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                UnityEngine.Texture.allowThreadedTextureCreation = argHelper.GetBoolean(false);
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"imageContentsHash", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_imageContentsHash, Setter = S_imageContentsHash} },
