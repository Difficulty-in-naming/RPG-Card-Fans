...
{
    public static class FairyGUI_Utils_HtmlImage_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new FairyGUI.Utils.HtmlImage();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.Utils.HtmlImage), result);
        ...
        private static void M_Create(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Utils.HtmlImage;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_loader(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.Utils.HtmlImage;
                var result = obj.loader;
...
{ new Puerts.MethodKey {Name = "Dispose", IsStatic = false}, M_Dispose }
                ...
                {
                    {"loader", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_loader, Setter = null} },
