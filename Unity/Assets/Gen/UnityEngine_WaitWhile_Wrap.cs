...
{
    public static class UnityEngine_WaitWhile_Wrap
    {
            ...
            try
            {

                {
                ...
                
                    {
                        ...
                        var result = new UnityEngine.WaitWhile(Arg0);
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.WaitWhile), result);
        ...
        private static void G_keepWaiting(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.WaitWhile;
