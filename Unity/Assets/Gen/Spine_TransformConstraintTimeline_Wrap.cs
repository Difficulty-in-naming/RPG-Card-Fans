...
{
    public static class Spine_TransformConstraintTimeline_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new Spine.TransformConstraintTimeline(Arg0);
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.TransformConstraintTimeline), result);
                    }
                }
        ...
        private static void M_SetFrame(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.TransformConstraintTimeline;
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void G_TransformConstraintIndex(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.TransformConstraintTimeline;
                var result = obj.TransformConstraintIndex;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void S_TransformConstraintIndex(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.TransformConstraintTimeline;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.TransformConstraintIndex = argHelper.GetInt32(false);
        ...
        private static void G_ENTRIES(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = Spine.TransformConstraintTimeline.ENTRIES;
                Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"TransformConstraintIndex", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_TransformConstraintIndex, Setter = S_TransformConstraintIndex} },
