...
{
    public static class Spine_Unity_SpineTransformConstraint_Wrap
    {
            ...
            try
            {
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new Spine.Unity.SpineTransformConstraint(Arg0, Arg1, Arg2, Arg3);
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.Unity.SpineTransformConstraint), result);
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new Spine.Unity.SpineTransformConstraint(Arg0, Arg1, Arg2);
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new Spine.Unity.SpineTransformConstraint(Arg0, Arg1);
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new Spine.Unity.SpineTransformConstraint(Arg0);
                ...
                
                {
            
                    {
                        ...
                        var result = new Spine.Unity.SpineTransformConstraint();
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to Spine.Unity.SpineTransformConstraint constructor");
