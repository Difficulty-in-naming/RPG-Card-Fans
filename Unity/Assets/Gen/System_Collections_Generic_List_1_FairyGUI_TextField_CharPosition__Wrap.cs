...
{
    public static class System_Collections_Generic_List_1_FairyGUI_TextField_CharPosition__Wrap
    {
            ...
            try
            {
                ...
                if (paramLen == 0)
                {
                    ...
                    
                    {
                        ...
                        var result = new System.Collections.Generic.List<FairyGUI.TextField.CharPosition>();
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(System.Collections.Generic.List<FairyGUI.TextField.CharPosition>), result);
                    }
                }
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var result = new System.Collections.Generic.List<FairyGUI.TextField.CharPosition>(Arg0);
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(System.Collections.Generic.List<FairyGUI.TextField.CharPosition>), result);
                    }
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Collections.Generic.IEnumerable<FairyGUI.TextField.CharPosition>), false, false))
                    {
                        
                        var Arg0 = argHelper0.Get<System.Collections.Generic.IEnumerable<FairyGUI.TextField.CharPosition>>(false);
                        var result = new System.Collections.Generic.List<FairyGUI.TextField.CharPosition>(Arg0);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to System.Collections.Generic.List<FairyGUI.TextField.CharPosition> constructor");
            }
            catch (Exception e)
            {
        ...
        private static void M_Add(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as System.Collections.Generic.List<FairyGUI.TextField.CharPosition>;
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.Get<FairyGUI.TextField.CharPosition>(false);
                        obj.Add(Arg0);
            ...
            try
            {
                ...
                if (paramLen == 4)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        ...
                        && argHelper2.IsMatch(Puerts.JsValueType.NativeObject, typeof(FairyGUI.TextField.CharPosition), false, false)
                        && argHelper3.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Collections.Generic.IComparer<FairyGUI.TextField.CharPosition>), false, false))
                    {
                        
                        var Arg0 = argHelper0.GetInt32(false);
                        var Arg1 = argHelper1.GetInt32(false);
                        var Arg2 = argHelper2.Get<FairyGUI.TextField.CharPosition>(false);
                        var Arg3 = argHelper3.Get<System.Collections.Generic.IComparer<FairyGUI.TextField.CharPosition>>(false);
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NativeObject, typeof(FairyGUI.TextField.CharPosition), false, false))
                    {
                ...
                if (paramLen == 2)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NativeObject, typeof(FairyGUI.TextField.CharPosition), false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Collections.Generic.IComparer<FairyGUI.TextField.CharPosition>), false, false))
                    {
                        
                        var Arg0 = argHelper0.Get<FairyGUI.TextField.CharPosition>(false);
                        var Arg1 = argHelper1.Get<System.Collections.Generic.IComparer<FairyGUI.TextField.CharPosition>>(false);
        ...
        private static void M_CopyTo(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(FairyGUI.TextField.CharPosition[]), false, false))
                    {
                ...
                if (paramLen == 4)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(FairyGUI.TextField.CharPosition[]), false, false)
                        && argHelper2.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        && argHelper3.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        
                        var Arg0 = argHelper0.GetInt32(false);
                        var Arg1 = argHelper1.Get<FairyGUI.TextField.CharPosition[]>(false);
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.Get<System.Predicate<FairyGUI.TextField.CharPosition>>(false);
        ...
        private static void M_FindIndex(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject | Puerts.JsValueType.Function, typeof(System.Predicate<FairyGUI.TextField.CharPosition>), false, false))
                    {
                ...
                if (paramLen == 2)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject | Puerts.JsValueType.Function, typeof(System.Predicate<FairyGUI.TextField.CharPosition>), false, false))
                    {
                        
                        var Arg0 = argHelper0.GetInt32(false);
                        var Arg1 = argHelper1.Get<System.Predicate<FairyGUI.TextField.CharPosition>>(false);
                ...
                if (paramLen == 3)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        && argHelper2.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject | Puerts.JsValueType.Function, typeof(System.Predicate<FairyGUI.TextField.CharPosition>), false, false))
                    {
                        
                        var Arg0 = argHelper0.GetInt32(false);
                        var Arg1 = argHelper1.GetInt32(false);
                        var Arg2 = argHelper2.Get<System.Predicate<FairyGUI.TextField.CharPosition>>(false);
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.Get<System.Action<FairyGUI.TextField.CharPosition>>(false);
                        obj.ForEach(Arg0);
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var Arg0 = argHelper0.GetInt32(false);
                        var Arg1 = argHelper1.Get<System.Collections.Generic.IEnumerable<FairyGUI.TextField.CharPosition>>(false);
        ...
        private static void M_Sort(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 1)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Collections.Generic.IComparer<FairyGUI.TextField.CharPosition>), false, false))
                    {
                        
                        var Arg0 = argHelper0.Get<System.Collections.Generic.IComparer<FairyGUI.TextField.CharPosition>>(false);
                        obj.Sort(Arg0);
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject | Puerts.JsValueType.Function, typeof(System.Comparison<FairyGUI.TextField.CharPosition>), false, false))
                    {
                        
                        var Arg0 = argHelper0.Get<System.Comparison<FairyGUI.TextField.CharPosition>>(false);
                        obj.Sort(Arg0);
                ...
                if (paramLen == 3)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        && argHelper2.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(System.Collections.Generic.IComparer<FairyGUI.TextField.CharPosition>), false, false))
                    {
                        
                        var Arg0 = argHelper0.GetInt32(false);
                        var Arg1 = argHelper1.GetInt32(false);
                        var Arg2 = argHelper2.Get<System.Collections.Generic.IComparer<FairyGUI.TextField.CharPosition>>(false);
        ...
        private static void SetItem(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                {
                    var key = keyHelper.GetInt32(false);
                    obj[key] = valueHelper.Get<FairyGUI.TextField.CharPosition>(false);
                    return;
                }
