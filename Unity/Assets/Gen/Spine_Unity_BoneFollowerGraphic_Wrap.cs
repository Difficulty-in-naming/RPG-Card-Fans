...
{
    public static class Spine_Unity_BoneFollowerGraphic_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                {
                    {
                        var result = new Spine.Unity.BoneFollowerGraphic();
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(Spine.Unity.BoneFollowerGraphic), result);
                    }
                }
            }
            catch (Exception e)
        ...
        private static void M_SetBone(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Unity.BoneFollowerGraphic;
                {
        ...
        private static void G_initializeOnAwake(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            ...
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Unity.BoneFollowerGraphic;
                var result = obj.initializeOnAwake;
                Puerts.PuertsDLL.ReturnBoolean(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        private static void G_followBoneRotation(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            ...
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Unity.BoneFollowerGraphic;
                var result = obj.followBoneRotation;
                Puerts.PuertsDLL.ReturnBoolean(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        private static void G_followLocalScale(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            ...
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Unity.BoneFollowerGraphic;
                var result = obj.followLocalScale;
                Puerts.PuertsDLL.ReturnBoolean(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        private static void G_followXYPosition(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            ...
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Unity.BoneFollowerGraphic;
                var result = obj.followXYPosition;
                Puerts.PuertsDLL.ReturnBoolean(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        private static void G_followZPosition(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            ...
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as Spine.Unity.BoneFollowerGraphic;
                var result = obj.followZPosition;
                Puerts.PuertsDLL.ReturnBoolean(isolate, info, result);
            }
            catch (Exception e)
            {
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Properties = new System.Collections.Generic.Dictionary<string, Puerts.PropertyRegisterInfo>()
                {
                    ...
                    {"followBoneRotation", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_followBoneRotation, Setter = S_followBoneRotation} },
                    ...
                    {"followLocalScale", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_followLocalScale, Setter = S_followLocalScale} },
                    {"followXYPosition", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_followXYPosition, Setter = S_followXYPosition} },
                    {"followZPosition", new Puerts.PropertyRegisterInfo(){ IsStatic = false, Getter = G_followZPosition, Setter = S_followZPosition} },
