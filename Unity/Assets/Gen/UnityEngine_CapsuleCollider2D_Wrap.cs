...
{
    public static class UnityEngine_CapsuleCollider2D_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.CapsuleCollider2D();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.CapsuleCollider2D), result);
        ...
        private static void G_size(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.CapsuleCollider2D;
                var result = obj.size;
        ...
        private static void S_direction(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.CapsuleCollider2D;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.direction = (UnityEngine.CapsuleDirection2D)argHelper.GetInt32(false);
