...
namespace PuertsStaticWrap
{
    public static class UnityEngine_AnimationCurve_Wrap
    {
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void M_CalculateCurveDuration(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.AnimationCurve;
                {
                    {
                        var result = obj.CalculateCurveDuration();
                        Puerts.PuertsDLL.ReturnNumber(isolate, info, result);
                    }
                }
            }
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Methods = new System.Collections.Generic.Dictionary<Puerts.MethodKey, Puerts.V8FunctionCallback>()
                {
                    ...
                    { new Puerts.MethodKey {Name = "CalculateCurveDuration", IsStatic = false}, M_CalculateCurveDuration },
