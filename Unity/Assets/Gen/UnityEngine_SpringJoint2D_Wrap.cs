...
{
    public static class UnityEngine_SpringJoint2D_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.SpringJoint2D();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.SpringJoint2D), result);
        ...
        private static void G_autoConfigureDistance(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.SpringJoint2D;
