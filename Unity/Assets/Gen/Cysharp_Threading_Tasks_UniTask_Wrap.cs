        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 2)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(Cysharp.Threading.Tasks.IUniTaskSource), false, false)
            ...
            try
            {
                ...
                if (paramLen == 4)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.Number, null, false, false)
                        ...
                        && argHelper3.IsMatch(Puerts.JsValueType.NativeObject, typeof(System.Threading.CancellationToken), false, false))
                    {
        ...
        private static void F_Void(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 2)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject | Puerts.JsValueType.Function, typeof(System.Func<System.Threading.CancellationToken, Cysharp.Threading.Tasks.UniTaskVoid>), false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.NativeObject, typeof(System.Threading.CancellationToken), false, false))
                    {
        ...
        private static void F_Run(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 3)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject | Puerts.JsValueType.Function, typeof(System.Func<System.Object, Cysharp.Threading.Tasks.UniTask>), false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.Any, typeof(System.Object), false, false)
                        && argHelper2.IsMatch(Puerts.JsValueType.Boolean, null, false, false))
                    {
        ...
        private static void F_WhenAll(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen >= 0)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(Cysharp.Threading.Tasks.UniTask), false, false))
                    {
