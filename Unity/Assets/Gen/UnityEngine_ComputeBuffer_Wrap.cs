...
{
    public static class UnityEngine_ComputeBuffer_Wrap
    {
            ...
            try
            {
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new UnityEngine.ComputeBuffer(Arg0, Arg1);
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.ComputeBuffer), result);
                ...
                
                {
                ...
                
                    {
                        ...
                        var Arg2 = (UnityEngine.ComputeBufferType)argHelper2.GetInt32(false);
                    
                        var result = new UnityEngine.ComputeBuffer(Arg0, Arg1, Arg2);
                ...
                
                {
                ...
                
                    {
                        ...
                        var Arg3 = (UnityEngine.ComputeBufferMode)argHelper3.GetInt32(false);
                    
                        var result = new UnityEngine.ComputeBuffer(Arg0, Arg1, Arg2, Arg3);
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.ComputeBuffer constructor");
        ...
        private static void M_Dispose(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.ComputeBuffer;
