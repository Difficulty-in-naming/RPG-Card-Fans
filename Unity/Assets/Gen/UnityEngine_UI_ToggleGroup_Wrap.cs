        ...
        private static void M_NotifyToggleOn(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.UI.Toggle), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Boolean, null, false, false))
