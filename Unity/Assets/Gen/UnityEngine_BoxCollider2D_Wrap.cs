...
{
    public static class UnityEngine_BoxCollider2D_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.BoxCollider2D();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.BoxCollider2D), result);
        ...
        private static void G_size(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.BoxCollider2D;
                var result = obj.size;
