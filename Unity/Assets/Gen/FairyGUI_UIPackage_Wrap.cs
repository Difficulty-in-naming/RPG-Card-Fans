    ...
    public static class FairyGUI_UIPackage_Wrap
    {
        ...
        private static void F_AddPackage(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                {
                    var argHelper0 = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.AssetBundle), false, false))
                    {
                        var Arg0 = argHelper0.Get<UnityEngine.AssetBundle>(false);
                ...
                if (paramLen == 2)
                {
                    ...
                    var argHelper1 = new Puerts.ArgumentHelper((int)data, isolate, info, 1);
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.AssetBundle), false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.AssetBundle), false, false))
                    {
                        var Arg0 = argHelper0.Get<UnityEngine.AssetBundle>(false);
                        var Arg1 = argHelper1.Get<UnityEngine.AssetBundle>(false);
                        var result = FairyGUI.UIPackage.AddPackage(Arg0,Arg1);
                        Puerts.ResultHelper.Set((int)data, isolate, info, result);
                        return;
                    }
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject | Puerts.JsValueType.Function, typeof(FairyGUI.UIPackage.LoadResource), false, false))
                    {
                        var Arg0 = argHelper0.GetString(false);
                        var Arg1 = argHelper1.Get<FairyGUI.UIPackage.LoadResource>(false);
                        var result = FairyGUI.UIPackage.AddPackage(Arg0,Arg1);
                        Puerts.ResultHelper.Set((int)data, isolate, info, result);
                        return;
                    }
                ...
                if (paramLen == 3)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(byte[]), false, false)
                        ...
                        && argHelper2.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject | Puerts.JsValueType.Function, typeof(FairyGUI.UIPackage.LoadResource), false, false))
                    {
                        var Arg0 = argHelper0.Get<byte[]>(false);
                        var Arg1 = argHelper1.GetString(false);
                        var Arg2 = argHelper2.Get<FairyGUI.UIPackage.LoadResource>(false);
                        var result = FairyGUI.UIPackage.AddPackage(Arg0,Arg1,Arg2);
                        Puerts.ResultHelper.Set((int)data, isolate, info, result);
                        return;
                    }
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(byte[]), false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false)
                        && argHelper2.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject | Puerts.JsValueType.Function, typeof(FairyGUI.UIPackage.LoadResourceAsync), false, false))
                    {
                        var Arg0 = argHelper0.Get<byte[]>(false);
                        var Arg1 = argHelper1.GetString(false);
                        var Arg2 = argHelper2.Get<FairyGUI.UIPackage.LoadResourceAsync>(false);
                        var result = FairyGUI.UIPackage.AddPackage(Arg0,Arg1,Arg2);
                        Puerts.ResultHelper.Set((int)data, isolate, info, result);
                        return;
                    }
        ...
        private static void F_CreateObjectFromURL(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                if (paramLen == 2)
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.String, null, false, false)
                        && argHelper1.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject | Puerts.JsValueType.Function, typeof(FairyGUI.UIPackage.CreateObjectCallback), false, false))
                    {
                        var Arg0 = argHelper0.GetString(false);
                        var Arg1 = argHelper1.Get<FairyGUI.UIPackage.CreateObjectCallback>(false);
            ...
            {
                {
                    ...
                    var argHelper2 = new Puerts.ArgumentHelper((int)data, isolate, info, 2);
                    {
                        var Arg0 = argHelper0.GetString(false);
                        var Arg1 = argHelper1.GetString(false);
                        var Arg2 = argHelper2.Get<FairyGUI.UIPackage.CreateObjectCallback>(false);
            ...
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.UIPackage;
                {
                    ...
                    var argHelper2 = new Puerts.ArgumentHelper((int)data, isolate, info, 2);
                    {
                        ...
                        var Arg2 = (FairyGUI.DestroyMethod)argHelper2.GetInt32(false);
        ...
        private static void S_branch(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                FairyGUI.UIPackage.branch = argHelper.GetString(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        private static void S_customId(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.UIPackage;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.customId = argHelper.GetString(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        private static void S_unloadBundleByFGUI(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            ...
            {
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                FairyGUI.UIPackage.unloadBundleByFGUI = argHelper.GetBoolean(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
        ...
        private static void A_onReleaseResource(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            ...
            {
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                FairyGUI.UIPackage.onReleaseResource += argHelper.Get<System.Action<FairyGUI.PackageItem>>(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
