            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.ParticleSystem.RotationBySpeedModule();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.ParticleSystem.RotationBySpeedModule), result);
