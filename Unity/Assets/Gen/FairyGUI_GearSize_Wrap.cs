...
{
    public static class FairyGUI_GearSize_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new FairyGUI.GearSize(Arg0);
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.GearSize), result);
                    }
                }
        ...
        private static void M_Apply(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.GearSize;
