...
{
    public static class TMPro_TMP_Offset_Wrap
    {
            ...
            try
            {
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new TMPro.TMP_Offset(Arg0, Arg1, Arg2, Arg3);
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(TMPro.TMP_Offset), result);
                ...
                
                {
                ...
                
                    {
                        ...
                        var result = new TMPro.TMP_Offset(Arg0, Arg1);
                ...
                
                {
            
                    {
                        ...
                        var result = new TMPro.TMP_Offset();
                ...
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to TMPro.TMP_Offset constructor");
        ...
        private static void M_GetHashCode(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (TMPro.TMP_Offset)Puerts.Utils.GetSelf((int)data, self);
        ...
        private static void M_Equals(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NativeObject, typeof(TMPro.TMP_Offset), false, false))
                
                    {
                
                        var Arg0 = argHelper0.Get<TMPro.TMP_Offset>(false);
        ...
        private static void S_horizontal(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (TMPro.TMP_Offset)Puerts.Utils.GetSelf((int)data, self);
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.horizontal = argHelper.GetFloat(false);
                Puerts.Utils.SetSelf((int)data, self, obj);
            }
            catch (Exception e)
            {
        ...
        private static void S_vertical(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = (TMPro.TMP_Offset)Puerts.Utils.GetSelf((int)data, self);
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.vertical = argHelper.GetFloat(false);
                Puerts.Utils.SetSelf((int)data, self, obj);
            }
            catch (Exception e)
            {
        ...
        private static void G_zero(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                ...
                var result = TMPro.TMP_Offset.zero;
