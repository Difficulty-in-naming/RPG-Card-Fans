...
{
    public static class FairyGUI_RotationGesture_Wrap
    {
            ...
            {
                {
                    var argHelper0 = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                    {
                        ...
                        var result = new FairyGUI.RotationGesture(Arg0);
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.RotationGesture), result);
                    }
                }
            }
            catch (Exception e)
        ...
        private static void M_Dispose(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.RotationGesture;
                {
                    {
                        obj.Dispose();
                    }
        ...
        private static void S_delta(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.RotationGesture;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.delta = argHelper.GetFloat(false);
            }
            catch (Exception e)
            {
                Puerts.PuertsDLL.ThrowException(isolate, "c# exception:" + e.Message + ",stack:" + e.StackTrace);
