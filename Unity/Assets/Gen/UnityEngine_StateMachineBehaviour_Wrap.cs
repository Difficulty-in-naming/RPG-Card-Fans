        ...
        private static void M_OnStateEnter(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.Animator), false, false) && argHelper1.IsMatch(Puerts.JsValueType.NativeObject, typeof(UnityEngine.AnimatorStateInfo), false, false) && argHelper2.IsMatch(Puerts.JsValueType.Number, null, false, false))
        ...
        private static void M_OnStateMachineEnter(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
            ...
            
                {
                    ...
                    if (argHelper0.IsMatch(Puerts.JsValueType.NullOrUndefined | Puerts.JsValueType.NativeObject, typeof(UnityEngine.Animator), false, false) && argHelper1.IsMatch(Puerts.JsValueType.Number, null, false, false))
