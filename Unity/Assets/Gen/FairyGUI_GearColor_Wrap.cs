...
{
    public static class FairyGUI_GearColor_Wrap
    {
            ...
            try
            {
                ...
                
                {
                    ...
                    
                    {
                        ...
                        var result = new FairyGUI.GearColor(Arg0);
                        
                        
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(FairyGUI.GearColor), result);
                    }
                }
        ...
        private static void M_Apply(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as FairyGUI.GearColor;
