...
{
    public static class UnityEngine_UI_StencilMaterial_Wrap
    {
        ...
        private static IntPtr Constructor(IntPtr isolate, IntPtr info, int paramLen, long data)
        {
            try
            {
                Puerts.PuertsDLL.ThrowException(isolate, "invalid arguments to UnityEngine.UI.StencilMaterial constructor");
            }
            catch (Exception e)
            {
            ...
            try
            {
                if (paramLen == 5)
                {
                        ...
                        && argHelper4.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var Arg2 = (UnityEngine.Rendering.StencilOp)argHelper2.GetInt32(false);
                        var Arg3 = (UnityEngine.Rendering.CompareFunction)argHelper3.GetInt32(false);
                        var Arg4 = (UnityEngine.Rendering.ColorWriteMask)argHelper4.GetInt32(false);
                        var result = UnityEngine.UI.StencilMaterial.Add(Arg0,Arg1,Arg2,Arg3,Arg4);
                ...
                if (paramLen == 7)
                {
                        ...
                        && argHelper6.IsMatch(Puerts.JsValueType.Number, null, false, false))
                    {
                        ...
                        var result = UnityEngine.UI.StencilMaterial.Add(Arg0,Arg1,Arg2,Arg3,Arg4,Arg5,Arg6);
                        Puerts.ResultHelper.Set((int)data, isolate, info, result);
                        return;
                    }
                }
        ...
        [Puerts.MonoPInvokeCallback(typeof(Puerts.V8FunctionCallback))]
        private static void F_ClearAll(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                {
        ...
        public static Puerts.TypeRegisterInfo GetRegisterInfo()
        {
            return new Puerts.TypeRegisterInfo()
            {
                ...
                Methods = new System.Collections.Generic.Dictionary<Puerts.MethodKey, Puerts.V8FunctionCallback>()
                {
                    ...
                    { new Puerts.MethodKey {Name = "ClearAll", IsStatic = true}, F_ClearAll },
                },
