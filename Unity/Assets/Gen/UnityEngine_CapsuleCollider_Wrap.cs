...
{
    public static class UnityEngine_CapsuleCollider_Wrap
    {
            ...
            try
            {

                {
            
                    {
                        ...
                        var result = new UnityEngine.CapsuleCollider();
                
                        return Puerts.Utils.GetObjectPtr((int)data, typeof(UnityEngine.CapsuleCollider), result);
        ...
        private static void G_center(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.CapsuleCollider;
        ...
        private static void S_direction(IntPtr isolate, IntPtr info, IntPtr self, int paramLen, long data)
        {
            try
            {
                var obj = Puerts.Utils.GetSelf((int)data, self) as UnityEngine.CapsuleCollider;
                var argHelper = new Puerts.ArgumentHelper((int)data, isolate, info, 0);
                obj.direction = argHelper.GetInt32(false);
