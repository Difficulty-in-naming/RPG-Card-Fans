...
class UI_Title extends ModTheSpire_Title_1.View_Title {
    ...
    OnInit(...args) {
        ...
        for (let i = 1; i <= 7; i++) {
            this.TopCloud.push(new TitleCloud(`ui://ModTheSpire_Title/topCloud${i}`, Mathf_1.Mathf.RandomRange(10, 50), Mathf_1.Mathf.RandomRange(-1920, 1920), this.TopCloudHolder));
        }
        for (let i = 1; i <= 13; i++) {
            this.MidCloud.push(new TitleCloud(`ui://ModTheSpire_Title/midCloud${i}`, Mathf_1.Mathf.RandomRange(-50, -10), Mathf_1.Mathf.RandomRange(-1920, 1920), this.MidCloudHolder));
        }
    }
    OnUpdate() {
