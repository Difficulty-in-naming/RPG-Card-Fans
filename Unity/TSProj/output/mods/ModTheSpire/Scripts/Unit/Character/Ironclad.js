...
class Ironclad {
    ...
    Loader = new SpineLoader_1.SpineLoader(FileHelper_1.default.FormatPath2("Characters/ironclad/idle/skeleton.atlas"), FileHelper_1.default.FormatPath2("Characters/ironclad/idle/skeleton.json"), FileHelper_1.default.FormatPath2("Characters/ironclad/idle/ironclad.png"));
    CardFrame;
    InitCard;
}
