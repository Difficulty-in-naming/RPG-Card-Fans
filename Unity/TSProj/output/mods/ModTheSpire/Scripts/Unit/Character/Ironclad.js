...
class Ironclad {
    constructor() {
        ...
        this.Loader = new SpineLoader_1.SpineLoader(FileHelper_1.default.FormatPath2("Characters/ironclad/idle/skeleton.atlas"), FileHelper_1.default.FormatPath2("Characters/ironclad/idle/skeleton.json"), FileHelper_1.default.FormatPath2("Characters/ironclad/idle/ironclad.png"));
        ///////////////////////////////
    }
}
exports.default = Ironclad;
//# sourceMappingURL=Ironclad.js.map