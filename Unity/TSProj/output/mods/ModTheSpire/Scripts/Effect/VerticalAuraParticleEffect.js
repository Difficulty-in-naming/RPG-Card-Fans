...
class VerticalAuraParticleEffect extends AbstractEffect_1.AbstractEffect {
    ...
    constructor(c, x, y) {
        ...
        this.Loader.alpha = 0;
        this.Tween = new tween_1.default.Tween({ a: this.Loader.color.a }).to({ a: 1 }, 200).easing(tween_1.default.Easing.Sinusoidal.InOut)
            .onUpdate(object => {
            this.Loader.alpha = object.a;
        })
            .start()
            .onComplete(object => {
            this.Tween = new tween_1.default.Tween({ a: this.Loader.color.a }).to({ a: 0 }, 800).easing(tween_1.default.Easing.Sinusoidal.InOut)
                .onUpdate(object => {
                this.Loader.alpha = object.a;
            }).onComplete(() => {
                this.Loader.Dispose();
