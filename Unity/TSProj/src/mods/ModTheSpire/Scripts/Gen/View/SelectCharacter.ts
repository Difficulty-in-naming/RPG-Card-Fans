...
export class View_CharacterButton extends UIBase
{
    ...
    public static Url = new ViewInfo("SelectCharacter","CharacterButton")
    ...
    public CloseMySelf()
    {
        let url : string = View_CharacterButton.Url.toString() + "." + (<any>this).name;
...
export class View_SelectCharacter extends UIBase
{
    ...
    public static Url = new ViewInfo("SelectCharacter","SelectCharacter")
    public static CreatePanel(...args) : UIBase
    {
        let url : string = this.Url.toString() + "." + this.name;
        let panel : UIBase = UIKit.Inst().Get(url);
    ...
    public CloseMySelf()
    {
        let url : string = View_SelectCharacter.Url.toString() + "." + (<any>this).name;
        UIKit.Inst().Destroy(url);
    }
    //不要主动调用这个方法或者修改这个方法
    public Construct()
